...
public class PublicationBattleSharedManager {

    private AppCompatActivity context;
    private DatabaseReference databaseReference;

    public PublicationBattleSharedManager(AppCompatActivity context) {
        this.context = context;

        databaseReference = FirebaseDatabase.getInstance().getReference();
    }

    public void incrementViewCount(String user_id, String publicationId) {
