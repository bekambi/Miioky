package com.bekambimouen.miiokychallenge.child_recyclerview_share.adapter;
...
import com.bekambimouen.miiokychallenge.child_recyclerview.adapter.RecyclerViewAdapter;
...
import com.bekambimouen.miiokychallenge.full_image_share.RecyclerFullImageShare;
...
public class RecyclerViewShareAdapter extends RecyclerView.Adapter<RecyclerViewShareAdapter.ViewHolder> {
    ...
    public RecyclerViewShareAdapter(AppCompatActivity context, List<String> list, BattleModel battleModel,
    ...
    @NonNull
    @Override
    public RecyclerViewShareAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewShareAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(String url, int position) {
            ...
            bottomSheetShare = new BottomSheetSharePublication(context, null, battleModel.getUser_id(),
                    url, photo_id, "from_recyclerView_item", "", false);
        ...
        private final class GestureListenerLike extends GestureDetector.SimpleOnGestureListener {
            ...
            public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
                ...
                context.getWindow().setExitTransition(new Slide(Gravity.END));
                context.getWindow().setEnterTransition(new Slide(Gravity.START));
                Intent intent = new Intent(context, RecyclerFullImageShare.class);
                Gson gson = new Gson();
                String myGson = gson.toJson(battleModel);
