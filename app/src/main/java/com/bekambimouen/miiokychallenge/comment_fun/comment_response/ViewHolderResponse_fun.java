...
public class ViewHolderResponse_fun extends RecyclerView.ViewHolder {
    ...
    public ViewHolderResponse_fun(AppCompatActivity context, BattleModel_fun model, String comment_key,
