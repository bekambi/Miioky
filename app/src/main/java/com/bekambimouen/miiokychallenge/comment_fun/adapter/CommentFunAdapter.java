package com.bekambimouen.miiokychallenge.comment_fun.adapter;
...
import com.bekambimouen.miiokychallenge.comment_fun.adapter.viewholder.ViewHolderCommentFun;
...
public class CommentFunAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "CommentFunListAdapter";
    ...
    public CommentFunAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel_fun battleModel_fun,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolderCommentFun(context, battleModel_fun, itemImageUneClickListener,
                post_id_field, category_of_post, post_type, post_id, recyclerview_photo_id_upload,
                recyclerview_fieldLike_upload, admin_master, the_user_who_posted_id, group_id, relLayout_view_overlay, view);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ViewHolderCommentFun commentFun = (ViewHolderCommentFun) holder;
        commentFun.bindView(comment);

        if (battleModel_fun.getUser_id().equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid())) {
            commentFun.menu_item.setVisibility(View.VISIBLE);
            commentFun.menu_item.setOnClickListener(view -> {
                // show dialog
                ...
                positiveButton.setOnClickListener(view1 -> {
                    ...
                    if (!isConnected) {
                        ...
                        FirebaseDatabase.getInstance().getReference().
                                ...
                                .child(battleModel_fun.getUser_id()) //should be mphoto.getUser_id()
                                .child(battleModel_fun.getPhoto_id())
                                .child(context.getString(R.string.field_comments))
                                .child(comment.getCommentKey())
