package com.bekambimouen.miiokychallenge.comment_fun.adapter.viewholder;
...
public class ViewHolderCommentFun extends RecyclerView.ViewHolder {
    private static final String TAG = "ViewHolderCommentFun";
    ...
    public ViewHolderCommentFun(AppCompatActivity context, BattleModel_fun battleModel_fun, ItemImageUneClickListener itemImageUneClickListener,
        ...
        this.battleModel_fun = battleModel_fun;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for ( DataSnapshot ds :  snapshot.getChildren()){
                    ...
                    comment_username.setText(user_reponse.getUsername());
    ...
    private void removeLike() {
        ...
        Query query = myRef
                ...
                .child(battleModel_fun.getPhoto_id())
                ...
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    if (mLikedByCurrentUser &&
                        ...
                        myRef.child(context.getString(R.string.dbname_fun))
                                .child(battleModel_fun.getUser_id())
                                .child(battleModel_fun.getPhoto_id())
                                .child(context.getString(R.string.field_comments))
                                .child(mComment.getCommentKey())
                                .child(context.getString(R.string.field_likes))
                ...
                for ( DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    comment_profile_image_first_comment.setOnClickListener(v -> {
                        ...
                        if (user.getUser_id().equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid())) {
                            ...
                            intent.putExtra("user_main_recycler", myJson);
                        }
                        context.startActivity(intent);
                    });
            ...
            public void onClick(View v) {
                ...
                if (like_heart_first_comment.isSelected()) {
                    ...
                    like_heart_first_comment.likeAnimation(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            super.onAnimationEnd(animation);
                            removeLike_first_comment(user_id, parent_key, child_comment_key);
                        }
                    });
                    ...
                    like_heart_first_comment.likeAnimation(new AnimatorListenerAdapter() {
                        ...
                        public void onAnimationEnd(Animator animation) {
                            ...
                            if (!mLikedByCurrentUser_first_comment) {
                                addNewLike_first_comment(user_id, parent_key, child_comment_key);
                            }
                        }
                    });
                }
    ...
    private void removeLike_first_comment(String user_id, String parent_key, String child_comment_key) {
        Log.d(TAG, "onDoubleTap: single tap detected.");
        Query query = myRef
                .child(context.getString(R.string.dbname_videos))
                .child(battleModel_fun.getPhoto_id())
    ...
    public void addNewLike_first_comment(String user_id, String parent_key, String child_comment_key){
        Log.d(TAG, "addNewLike: adding new like");
        // update like count
        int count = Integer.parseInt(comment_likes_first_comment.getText().toString());
        String str = String.valueOf(count+1);
    ...
    private void setLikes_first_comment(String parent_key, String child_comment_key) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!comment_likes_first_comment.getText().toString().equals("0"))
                    comment_likes_first_comment.setVisibility(View.VISIBLE);
            }
