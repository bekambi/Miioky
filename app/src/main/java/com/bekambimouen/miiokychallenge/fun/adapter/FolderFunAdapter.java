...
public class FolderFunAdapter extends RecyclerView.Adapter<FolderFunAdapter.ViewHolder> {
    ...
    public FolderFunAdapter(Context context, List<FolderItem> folderList, VideoListFunAdapter videoAdapter,
                            ArrayList<VideoItem> videosList, Dialog dialog, TextView toolBar_textview, ProgressBar progressBar) {
