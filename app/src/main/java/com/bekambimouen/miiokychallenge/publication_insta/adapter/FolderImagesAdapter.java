...
public class FolderImagesAdapter extends RecyclerView.Adapter<FolderImagesAdapter.ViewHolder> {
    ...
    public FolderImagesAdapter(Context context, List<FolderItem> folderList, ImageAdapter imageAdapter,
