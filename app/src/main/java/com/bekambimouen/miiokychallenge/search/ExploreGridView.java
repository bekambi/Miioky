...
import com.bekambimouen.miiokychallenge.search.adapter.ExploreGridAdapter;
...
public class ExploreGridView extends AppCompatActivity implements OnLoadMoreItemsListener {
    private static final String TAG = "ExploreGridView";
    ...
    // vars
    private ExploreGridView context;
    ...
    private ArrayList<BattleModel> list, other_part_list, final_list, pagination;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explore_grid_view);
        context = this;
    ...
    private void init() {
        ...
        relLayout_search.setOnClickListener(view1 -> {
            if (relLayout_view_overlay != null)
                relLayout_view_overlay.setVisibility(View.VISIBLE);
            context.getWindow().setExitTransition(new Slide(Gravity.END));
            context.getWindow().setEnterTransition(new Slide(Gravity.START));
            Intent intent = new Intent(this, SeeAllSuggestions.class);
            intent.putExtra("from_grid_explorer", "from_grid_explorer");
    ...
    private void displayTheList() {
        ...
        adapter = new ExploreGridAdapter(context, pagination, progressBar, this,
