...
import com.bekambimouen.miiokychallenge.profile.ViewPostsBattle;
import com.bumptech.glide.Glide;
import com.google.gson.Gson;

import java.util.List;

public class ProfileGridViewBattleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "ProfileGridViewBattleAdapter";
    ...
    public ProfileGridViewBattleAdapter(AppCompatActivity context, List<BattleModel> list,
                                        User user, RelativeLayout relLayout_view_overlay) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == USER_PROFILE) {
            ...
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.layout_grid_comment_text, parent, false);
            return new CommentText(view);

        } else if (viewType == RECYCLER_IMAGE) {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.layout_grid_recycler_img, parent, false);
            ...
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.layout_grid_imagedouble, parent, false);
            return new ImageDoubleItem(view);

        } else if (viewType == VIDEO_DOUBLE) {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.layout_grid_videodouble, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (itemViewType == USER_PROFILE) {
            ...
            userProfileItem.itemView.setOnClickListener(view -> {
                ...
                Intent intent = new Intent(context, ViewPostsBattle.class);
                intent.putExtra("from_view_battle_profile", myUser);
