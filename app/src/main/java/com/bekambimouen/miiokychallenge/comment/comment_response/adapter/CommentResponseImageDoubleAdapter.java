...
import com.bekambimouen.miiokychallenge.comment.comment_response.ViewHolderResponse_image_double;
...
public class CommentResponseImageDoubleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "CommentResponseImageDoubleAdapter";
    ...
    public CommentResponseImageDoubleAdapter(AppCompatActivity context, ArrayList<CommentResponse> list,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == FIRST_COMMENT) {
            ...
            return new ViewHolderResponse_image_double(context, model, comment_key, mChildItemClickListener, relLayout_view_overlay, view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderResponse_image_double image_double = (ViewHolderResponse_image_double) holder;
            image_double.bindView(comment);

            if (model.getUser_id().equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid())) {
                image_double.menu_item.setVisibility(View.VISIBLE);
                image_double.menu_item.setOnClickListener(view -> {
                    // show dialog
