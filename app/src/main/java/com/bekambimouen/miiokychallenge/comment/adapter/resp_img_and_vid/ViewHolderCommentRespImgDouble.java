package com.bekambimouen.miiokychallenge.comment.adapter.resp_img_and_vid;
...
public class ViewHolderCommentRespImgDouble  extends RecyclerView.ViewHolder {
    private static final String TAG = "ViewHolderCommentRespImgDouble";
    ...
    public ViewHolderCommentRespImgDouble(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
