...
public class ViewHolderResponse_image_une extends RecyclerView.ViewHolder {
    private static final String TAG = "ViewHolderResponseComment_image_une";
    ...
    public ViewHolderResponse_image_une(AppCompatActivity context, BattleModel model, String comment_key,
