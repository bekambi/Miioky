...
public class ViewHolderFirstCommentHeader extends RecyclerView.ViewHolder {
    ...
    public ViewHolderFirstCommentHeader(AppCompatActivity context, BattleModel model, BattleModel comment_recycler_child,
