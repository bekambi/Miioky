package com.bekambimouen.miiokychallenge.comment.publication;
...
public class CommentPublication extends AppCompatActivity {
    private static final String TAG = "CommentPublication";
    ...
    //vars
    private CommentPublication context;
    ...
    private String fun_comment;
    private String userid, photo_id, recyclerview_photo_id;
    ...
    private String the_user_who_posted_id, post_id, category_of_post, post_type = "",
            post_id_field, userID;
    private long time;
    private Comment commentModel;
    private String recyclerview_photo_id_upload, recyclerview_fieldLike_upload;
    private boolean isCommentFromBattle = false, isCommentFromBattle_fun = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            fun_comment = getIntent().getStringExtra("fun_comment");
            ...
            Log.d(TAG, "onCreate: "+ exception.getLocalizedMessage());
        }
    ...
    private void uploadNewVideo(String videoUrl, String caption) {
        ...
        StorageReference thumbnailReference = mStorageReference
                .child(filePaths.FIREBASE_COMMENT_STORAGE + "/" + user_id + "/video/" +context.getString(R.string.thumbnails_path) +
        ...
        uploadTask.continueWithTask(task1 -> {
            ...
            if (task1.isSuccessful()) {
                ...
                StorageReference videoReference = mStorageReference
                        .child(filePaths.FIREBASE_COMMENT_STORAGE + "/" + user_id + "/video/" +context.getString(R.string.video_path) +
                                "/" + calendar.getTimeInMillis());
                ...
                uploadTask1.continueWithTask(task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (view_response_comment != null) {
                            ...
                            } else if (fun_comment != null) {
                                if (isInResponseTo)
                                    addNewChildResponseComment_vid_video_fun(caption, comment_key, thumbnailUrl, url);
                                else
                                    addNewResponseComment_vid_video_fun(caption, comment_key, thumbnailUrl, url);
                            ...
                            if (recyclerview_photo_id != null)
                                ...
                                addNewComment_vid_video_fun(caption, thumbnailUrl, url);
                            else
    ...
    private void addCommentVideoToDatabase(String newComment, String thumbnailUrl, String filePath) {
        ...
        try {
            ...
            myRef.child(getString(R.string.dbname_battle))
                    .child(userid) //should be mphoto.getUser_id()
                    .child(photo_id)
                    .child(getString(R.string.field_comments))
                    .child(commentID)
    ...
    // add response fun comment ____________________________________________________________________
    private void addNewComment_vid_video_fun(String newComment, String thumbnailUrl, String filePath){
        Log.d(TAG, "addNewComment: adding new comment: " + newComment);
        String commentID = myRef.push().getKey();
    ...
    private void addNewResponseComment_vid_video_fun(String newComment, String commentKey, String thumbnailUrl, String filePath){
        Log.d(TAG, "addNewComment: adding new comment: " + newComment);
        String commentID = myRef.push().getKey();
    ...
    private void addNewChildResponseComment_vid_video_fun(String newComment, String commentKey, String thumbnailUrl, String filePath){
        Log.d(TAG, "addNewComment: adding new comment: " + newComment);
        String commentID = myRef.push().getKey();
    ...
    private void uploadOnePhotoWithoutCompress(final String caption, Uri imageUri) {
        ...
        StorageReference storageReference = mStorageReference
                .child(filePaths.FIREBASE_COMMENT_STORAGE + "/" + user_id + "/image/" + calendar.getTimeInMillis());
            ...
            if (task.isSuccessful()) {
                ...
                if (view_response_comment != null) {
                    if (recyclerview_photo_id != null) {
                        ...
                        if (isInResponseTo)
                            addNewChildResponseComment_umg_video_fun(caption, comment_key, firebaseUrl.toString());
                        else
                            addNewResponseComment_umg_video_fun(caption, comment_key, firebaseUrl.toString());
                    ...
                    if (recyclerview_photo_id != null)
                        ...
                        addNewComment_img_video_fun(caption, firebaseUrl.toString());
                    else
    ...
    // add response fun comment ____________________________________________________________________
    private void addNewComment_img_video_fun(String newComment, String filePath){
        Log.d(TAG, "addNewComment: adding new comment: " + newComment);
        String commentID = myRef.push().getKey();
    ...
    private void addNewResponseComment_umg_video_fun(String newComment, String commentKey, String filePath){
        Log.d(TAG, "addNewComment: adding new comment: " + newComment);
        String commentID = myRef.push().getKey();
    ...
    private void addNewChildResponseComment_umg_video_fun(String newComment, String commentKey, String filePath){
        Log.d(TAG, "addNewComment: adding new comment: " + newComment);
        String commentID = myRef.push().getKey();
    ...
    private void sendSimpleCommentNotification(String url) {
        Date date = new Date();
        ...
        HashMap<Object, Object> map_notification = Utils_Map_Notification.setNotification(
                ...
                "", "", date.getTime(),
                isCommentFromBattle, isCommentFromBattle_fun,
                true, false, true, false, false, false, false, false,
                true, post_id_field, category_of_post, post_type, false, post_id, "", url, false,
    ...
    // send notification to owner post
    private void sendResponseCommentNotification(String comment, String commentKey, String answeringUserName, String url) {
        Date date = new Date();
        String new_key = myRef.push().getKey();
        assert new_key != null;
        // send notification to the post owner
        HashMap<Object, Object> map_notification = Utils_Map_Notification.setNotification(
                ...
                isCommentFromBattle, isCommentFromBattle_fun,
                true, false, true, false, false, false, false, false,
                false, post_id_field, category_of_post, post_type, true, post_id, "", url, true,
