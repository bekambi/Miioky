package com.bekambimouen.miiokychallenge.comment.adapter.recycler_img.adapter;
...
import com.bekambimouen.miiokychallenge.comment.adapter.recycler_img.ViewHolderCommentRecycler;
...
public class CommentRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentRecyclerAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_main_recycler_item, parent, false);
            return new RecyclerItemDisplay(context, battleModel, mComment, from_view_recyclerview, relLayout_view_overlay, view);

        } else {
            view = inflater.inflate(R.layout.layout_comment, parent, false);
            return new ViewHolderCommentRecycler(context, battleModel, itemImageUneClickListener,
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderCommentRecycler commentRecycler = (ViewHolderCommentRecycler) holder;
