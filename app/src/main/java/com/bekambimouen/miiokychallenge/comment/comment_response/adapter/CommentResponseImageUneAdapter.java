...
import com.bekambimouen.miiokychallenge.comment.comment_response.ViewHolderResponse_image_une;
...
public class CommentResponseImageUneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentResponseImageUneAdapter(AppCompatActivity context, ArrayList<CommentResponse> list,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == FIRST_COMMENT) {
            ...
            return new ViewHolderResponse_image_une(context, model, comment_key, mChildItemClickListener, relLayout_view_overlay, view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderResponse_image_une image_une = (ViewHolderResponse_image_une) holder;
