...
public class CommentImageUneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentImageUneAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_main_imageune_item, parent, false);
            return new ImageUneDisplay(context, battleModel, mComment, from_full_image, relLayout_view_overlay, view);
