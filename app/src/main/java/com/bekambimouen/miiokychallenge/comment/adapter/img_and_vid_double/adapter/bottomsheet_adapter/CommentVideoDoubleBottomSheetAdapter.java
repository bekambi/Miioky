package com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_double.adapter.bottomsheet_adapter;
...
public class CommentVideoDoubleBottomSheetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentVideoDoubleBottomSheetAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
