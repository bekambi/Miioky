...
public class CommentCommentTextAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentCommentTextAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_main_comment_text, parent, false);
            return new CommentTextDisplay(context, battleModel, mComment, relLayout_view_overlay, view);
