package com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_double;
...
public class ViewHolderCommentImageDouble extends RecyclerView.ViewHolder {
    private static final String TAG = "ViewHolderCommentImageDouble";
    ...
    public ViewHolderCommentImageDouble(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
                    ...
                    if (mLikedByCurrentUser &&
                            Objects.requireNonNull(ds.getValue(Like.class)).getUser_id()
                                    .equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser())
                                            .getUid())) {
                        Toast.makeText(context, "removeLike", Toast.LENGTH_SHORT).show();
            ...
            query1.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (commentsResponseList.size() == 1) {
                        ...
                        getComment_video_double(commentsResponseList.get(0).getUser_id(),
    ...
    private void getComment_video_double(String user_id, String parent_key, String child_comment_key) {
        Query query = myRef
                .child(context.getString(R.string.dbname_users))
                .orderByChild(context.getString(R.string.field_user_id))
                .equalTo(user_id);
