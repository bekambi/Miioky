package com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_double.adapter;
...
import com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_double.ViewHolderCommentImageDouble;
...
public class CommentVideoDoubleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentVideoDoubleAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_main_videodouble_item, parent, false);
            return new VideoDoubleDisplay(context, battleModel, mComment, from_full_video, relLayout_view_overlay, view);

        } else {
            view = inflater.inflate(R.layout.layout_comment, parent, false);
            return new ViewHolderCommentImageDouble(context, battleModel, itemImageUneClickListener,
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderCommentImageDouble commentImageDouble = (ViewHolderCommentImageDouble) holder;
