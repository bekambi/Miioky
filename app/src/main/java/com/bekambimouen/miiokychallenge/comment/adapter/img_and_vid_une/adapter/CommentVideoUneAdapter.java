package com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_une.adapter;
...
import com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_une.ViewHolderCommentImageUne;
...
public class CommentVideoUneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentVideoUneAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_main_videoune_item, parent, false);
            return new VideoUneDisplay(context, battleModel, mComment, from_full_video, relLayout_view_overlay, view);

        } else {
            view = inflater.inflate(R.layout.layout_comment, parent, false);
            return new ViewHolderCommentImageUne(context, battleModel, itemImageUneClickListener,
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderCommentImageUne commentImageUne = (ViewHolderCommentImageUne) holder;
            ...
            if (battleModel.getUser_id().equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid())) {
                commentImageUne.menu_item.setVisibility(View.VISIBLE);
                commentImageUne.menu_item.setOnClickListener(view -> {
                    // show dialog
