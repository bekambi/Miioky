package com.bekambimouen.miiokychallenge.comment.adapter.resp_img_and_vid.adapter;
...
import com.bekambimouen.miiokychallenge.comment.adapter.resp_img_and_vid.ViewHolderCommentRespImgDouble;
...
public class CommentRespVidDoubleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentRespVidDoubleAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
                                       ...
                                       String group_id, OnLoadMoreItemsListener mOnLoadMoreItemsListener,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_main_reponse_videodouble, parent, false);
            return new ResponseVideoDoubleDisplay(context, battleModel, mComment, from_full_video, relLayout_view_overlay, view);

        } else {
            view = inflater.inflate(R.layout.layout_comment, parent, false);
            return new ViewHolderCommentRespImgDouble(context, battleModel, itemImageUneClickListener,
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == PHOTO_HEADER) {
            ResponseVideoDoubleDisplay groupResponseImageDoubleDisplay = (ResponseVideoDoubleDisplay) holder;
            groupResponseImageDoubleDisplay.relLayout_answer_challenge.setVisibility(View.GONE);

        } else if (view_type == COMMENT) {
            ViewHolderCommentRespImgDouble respImgDouble = (ViewHolderCommentRespImgDouble) holder;
                    ...
                    positiveButton.setOnClickListener(view1 -> {
                        ...
                        if (!isConnected) {
                            ...
                            FirebaseDatabase.getInstance().getReference().
                                    ...
                                    .child(battleModel.getReponse_user_id()) //should be mphoto.getUser_id()
                                    .child(battleModel.getReponse_photoID())
                                    .child(context.getString(R.string.field_comments))
                                    .child(comment.getCommentKey())
