...
import com.bekambimouen.miiokychallenge.comment.comment_response.ViewHolderResponseComment_recycler;
...
public class CommentResponseRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "CommentResponseRecyclerAdapter";
    ...
    public CommentResponseRecyclerAdapter(AppCompatActivity context, ArrayList<CommentResponse> list,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == FIRST_COMMENT) {
            ...
            return new ViewHolderResponseComment_recycler(context, model, comment_key, mChildItemClickListener, relLayout_view_overlay, view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderResponseComment_recycler responseComment = (ViewHolderResponseComment_recycler) holder;
            responseComment.bindView(comment);

            if (model.getUser_id().equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid())) {
                responseComment.menu_item.setVisibility(View.VISIBLE);
                responseComment.menu_item.setOnClickListener(view -> {
                    // show dialog
