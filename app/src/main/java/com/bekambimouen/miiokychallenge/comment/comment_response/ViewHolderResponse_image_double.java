...
public class ViewHolderResponse_image_double extends RecyclerView.ViewHolder {
    ...
    public ViewHolderResponse_image_double(AppCompatActivity context, BattleModel model, String comment_key,
