package com.bekambimouen.miiokychallenge.comment;
...
import com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_double.adapter.CommentImageDoubleAdapter;
import com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_double.adapter.CommentVideoDoubleAdapter;
import com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_une.adapter.CommentCommentTextAdapter;
import com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_une.adapter.CommentImageUneAdapter;
import com.bekambimouen.miiokychallenge.comment.adapter.recycler_img.adapter.CommentRecyclerAdapter;
import com.bekambimouen.miiokychallenge.comment.adapter.img_and_vid_une.adapter.CommentVideoUneAdapter;
import com.bekambimouen.miiokychallenge.comment.adapter.resp_img_and_vid.adapter.CommentRespImgDoubleAdapter;
import com.bekambimouen.miiokychallenge.comment.adapter.resp_img_and_vid.adapter.CommentRespVidDoubleAdapter;
...
public class ViewComment extends AppCompatActivity implements OnLoadMoreItemsListener {
    ...
    // vars
    private ViewComment context;
    private CommentCommentTextAdapter commentTextAdapter;
    private CommentImageUneAdapter imageUne_adapter;
    private CommentVideoUneAdapter videoUne_adapter;
    private CommentRecyclerAdapter recycler_adapter;
    private CommentImageDoubleAdapter imageDouble_adapter;
    private CommentVideoDoubleAdapter videoDouble_adapter;
    private CommentRespImgDoubleAdapter response_img_adapter;
    private CommentRespVidDoubleAdapter response_vid_adapter;
    ...
    private String photo_id, from_full_image,
            from_full_video, from_view_recyclerview;
    private String comment_text,image_une, video_une, image_double, video_double,
            response_img_double, response_vid_double;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            comment_image_double = gson.fromJson(getIntent().getStringExtra("comment_image_double"),
                    BattleModel.class);
            comment_reponse_image_double = gson.fromJson(getIntent()
                    .getStringExtra("comment_reponse_image_double"), BattleModel.class);
        ...
        checkMark.setOnClickListener(v -> {
            if (comment_recycler != null) {
                if(!requireNonNull(mComment.getText()).toString().isEmpty()){
                    ...
                    Toast.makeText(ViewComment.this, getString(R.string.empty_field), Toast.LENGTH_SHORT).show();
                }
    ...
    private void setupWidgets(BattleModel battleModel){
        if (comment_recycler != null) {
            ...
            recycler_adapter = new CommentRecyclerAdapter(this, pagination, battleModel,
            ...
            if (image_double != null) {
                imageDouble_adapter = new CommentImageDoubleAdapter(this, pagination, battleModel,
                ...
                videoDouble_adapter = new CommentVideoDoubleAdapter(this, pagination, battleModel,
            ...
            if (response_img_double != null) {
                response_img_adapter = new CommentRespImgDoubleAdapter(context, pagination, battleModel,
                        itemImageUneClickListener, mComment, from_full_image, loading_progressBar,
                        post_id_field, category_of_post, post_type, post_id, recyclerview_photo_id_upload,
                        recyclerview_fieldLike_upload, admin_master, the_user_who_posted_id, group_id, this, relLayout_view_overlay);
                try {
                ...
                response_vid_adapter = new CommentRespVidDoubleAdapter(context, pagination, battleModel,
                        itemImageUneClickListener, mComment, from_full_video, loading_progressBar,
                        post_id_field, category_of_post, post_type, post_id, recyclerview_photo_id_upload,
                        recyclerview_fieldLike_upload, admin_master, the_user_who_posted_id, group_id, this, relLayout_view_overlay);
                try {
            ...
            if (comment_text != null) {
                commentTextAdapter = new CommentCommentTextAdapter(context, pagination, battleModel,
                ...
                if (commentTextAdapter.getItemCount() == 1)
                    relLayout_first_comment.setVisibility(View.VISIBLE);

            } else if (image_une != null) {
                imageUne_adapter = new CommentImageUneAdapter(context, pagination, battleModel,
                        itemImageUneClickListener, mComment, from_full_image, loading_progressBar,
                        post_id_field, category_of_post, post_type, post_id, recyclerview_photo_id_upload,
                        recyclerview_fieldLike_upload, admin_master, the_user_who_posted_id, group_id, this, relLayout_view_overlay);
                ...
                videoUne_adapter = new CommentVideoUneAdapter(this, pagination, battleModel,
                        itemImageUneClickListener, mComment, from_full_video, loading_progressBar,
                        post_id_field, category_of_post, post_type, post_id, recyclerview_photo_id_upload,
                        recyclerview_fieldLike_upload, admin_master, the_user_who_posted_id, group_id, this, relLayout_view_overlay);
