...
import com.bekambimouen.miiokychallenge.toro.CacheManager;
import com.bekambimouen.miiokychallenge.toro.PlayerDispatcher;
...
import static com.bekambimouen.miiokychallenge.toro.widget.Common.max;
...
public class Container extends RecyclerView {
    ...
    @CallSuper @Override public void onScrollStateChanged(int state) {
        ...
        candidates.sort(Common.ORDER_COMPARATOR);
