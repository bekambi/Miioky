...
public class FolderVideosChatAdapter extends RecyclerView.Adapter<FolderVideosChatAdapter.ViewHolder> {
    ...
    public FolderVideosChatAdapter(Context context, List<FolderItem> folderList, VideoChatListAdapter videoAdapter,
