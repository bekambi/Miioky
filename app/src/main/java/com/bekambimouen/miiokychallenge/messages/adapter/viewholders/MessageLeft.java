...
public class MessageLeft extends RecyclerView.ViewHolder implements View.OnClickListener,
        SeekBar.OnSeekBarChangeListener {
    private static final String TAG = "MessageLeft";
    // widgets
    ...
    public MessageLeft(@NonNull View itemView, AppCompatActivity context, int currentPlayingPosition) {
        super(itemView);
