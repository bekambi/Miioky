...
public class PrepareNextVideo {
    private static final String TAG = "PrepareNextVideo";
    private static final int CONNECTION_TIMEOUT = 5000; // 5 seconds

    public interface PreloadListener {
        void onPreloadProgress(BattleModel videoItem, int progress);
        void onPreloadComplete(BattleModel videoItem);
        void onPreloadError(BattleModel videoItem, Exception e);
    }

    public static void preDownloadVideo(Context context, BattleModel videoItem, PreloadListener listener) {
