...
public class PrepareNextVideoFun {
    private static final String TAG = "PrepareNextVideoFun";
    private static final int CONNECTION_TIMEOUT = 5000; // 5 seconds

    public interface PreloadListener {
        void onPreloadProgress(BattleModel_fun videoItem, int progress);
        void onPreloadComplete(BattleModel_fun videoItem);
        void onPreloadError(BattleModel_fun videoItem, Exception e);
    }

    public static void preDownloadVideo(Context context, BattleModel_fun videoItem, PreloadListener listener) {
