package com.bekambimouen.miiokychallenge.crushers_and_likers.adapter;
...
public class CrusherAndLikerAdapter extends RecyclerView.Adapter<CrusherAndLikerAdapter.MyViewHolder>
        implements Filterable {
    private static final String TAG = "CrusherAndLikerAdapter";
    // vars
    ...
    public CrusherAndLikerAdapter(AppCompatActivity context, ArrayList<User> list, ProgressBar progressBar, RelativeLayout relLayout_view_overlay) {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (t != 0)
                                if (!mUser.getUser_id().equals(user_id))
