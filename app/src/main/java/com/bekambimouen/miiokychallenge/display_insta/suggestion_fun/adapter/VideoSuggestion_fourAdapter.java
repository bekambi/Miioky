...
public class VideoSuggestion_fourAdapter extends RecyclerView.Adapter<VideoSuggestion_fourAdapter.ViewHolder> {
    private static final String TAG = "VideoSuggestion_fourAdapter";

    private final AppCompatActivity context;
    private final ArrayList<BattleModel_fun> list;
    private final RelativeLayout relLayout_view_overlay;

    public VideoSuggestion_fourAdapter(AppCompatActivity context, ArrayList<BattleModel_fun> list, RelativeLayout relLayout_view_overlay) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            intent.putExtra("position", 19 + position);
