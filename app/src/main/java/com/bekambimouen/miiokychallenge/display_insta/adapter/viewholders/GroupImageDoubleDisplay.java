...
import com.bekambimouen.miiokychallenge.groups.full_image.GroupImageDoubleFullImage;
...
public class GroupImageDoubleDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupImageDoubleGroupExplorer";
    ...
    public GroupImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
                                ...
                                if (user_groups.isGroup_private()) {
                                    ...
                                    linLayout_share_un.setOnClickListener(view -> {
                                        ...
                                        try {
                                            ...
                                            bundle.putString("item_view", "group_image_double");
                                    ...
                                    bottomSheetShare_deux = new BottomSheetSharePublication(context, model, model.getUser_id(), model.getUrlDeux(),
                                            model.getPhoto_id_deux(), "", "image_double", false);
                                    linLayout_share_deux.setOnClickListener(view -> {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddComment mSheetFragment = new GroupBottomSheetAddComment(context,
                    ...
                    null, null, "image_double", null, null, null,
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (mModel != null) {
                if (from_full_image != null) {
                    ...
                    Intent intent = new Intent(context, GroupImageDoubleFullImage.class);
                    Gson gson = new Gson();
