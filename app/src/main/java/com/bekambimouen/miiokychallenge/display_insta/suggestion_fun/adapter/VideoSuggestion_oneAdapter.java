...
public class VideoSuggestion_oneAdapter extends RecyclerView.Adapter<VideoSuggestion_oneAdapter.ViewHolder> {
    private static final String TAG = "VideoSuggestion_oneAdapter";

    private final AppCompatActivity context;
    private final ArrayList<BattleModel_fun> list;
    private final RelativeLayout relLayout_view_overlay;

    public VideoSuggestion_oneAdapter(AppCompatActivity context, ArrayList<BattleModel_fun> list, RelativeLayout relLayout_view_overlay) {
