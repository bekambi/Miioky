...
public class GroupSharedSingleBottomCircleImageDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupSharedSingleBottomCircleImageDisplay(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    private final class GestureListenerLike extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            intent.putExtra("circle_image_single_bottom", "circle_image_single_bottom");
            context.startActivity(intent);
