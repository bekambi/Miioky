...
public class GroupSharedSingleBottomVideoUneDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupSharedSingleBottomVideoUneDisplay(AppCompatActivity context, BattleModel mModel,
        ...
        thumbnail.setOnTouchListener((view, motionEvent) -> detector_video.onTouchEvent(motionEvent));
    ...
    public void init(BattleModel model) {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for(DataSnapshot ds : dataSnapshot.getChildren()){
                                ...
                                relLayout_username.setOnClickListener(view -> {
                                    ...
                                    context.getWindow().setEnterTransition(new Slide(Gravity.START));
                                    Intent intent;
                                    if (photo.getUser_id().equals(user_id) && user_groups.getAdmin_master().equals(user_id)) {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null, "video_une_single_bottom", null,
