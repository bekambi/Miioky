...
public class GroupSharedTopBottomRecyclerItemDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedTopBottomRecyclerItemDisplay";
    ...
    public GroupSharedTopBottomRecyclerItemDisplay(AppCompatActivity context, BattleModel mModel,
                                                   MyEditText mComment,
