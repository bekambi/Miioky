...
public class SharedSingleTopVideoUneDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedSingleTopVideoUneDisplay";
    ...
    public SharedSingleTopVideoUneDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            BottomSheetAddCommentShare bottomSheetFragmentShare = new BottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null,
                    null, "video_une_single_top", null, null,
                    null, null, null, null,
