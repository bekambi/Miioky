...
public class SharedImageDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public SharedImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                    MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            BottomSheetAddCommentShare bottomSheetFragmentShare = new BottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null,
                    null, null, null, null,
                    "image_double_on_miioky", null, null, null, relLayout_view_overlay);
            linLayout_comment.setOnClickListener(view -> {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (mModel != null) {
                if (from_full_image != null) {
                    ...
                    intent.putExtra("image_double_single_top_bottom", "image_double_single_top_bottom");
