...
public class SharedResponseVideoDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public SharedResponseVideoDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                            MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            BottomSheetAddCommentShare bottomSheetFragmentShare = new BottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null,
                    null, null, null,
                    "response_vid_double_on_miioky", relLayout_view_overlay);
            linLayout_comment.setOnClickListener(view -> {
