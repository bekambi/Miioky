...
public class GroupSharedTopBottomResponseImageDoubleDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedTopBottomResponseImageDoubleDisplay";
    ...
    public GroupSharedTopBottomResponseImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
        ...
        // pour régler le pb de activity destroyed dû au context du glide
        // l'image une
        ...
        // response caption ____________________________________________________
        ...
        // caption invite ________________________________________________________
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                    ...
                    null, null, model, null, null, null,
                    null, null, null, null, null,
                    null, null, null, "response_img_double_top_bottom", null, relLayout_view_overlay);
            linLayout_comment.setOnClickListener(view -> {
    ...
    private final class GestureListenerLike_un extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (mModel != null) {
                ...
                intent.putExtra("battleModel_response_image_double", myGson);
                intent.putExtra("position", 0);
                intent.putExtra("response_img_double_top_bottom", "response_img_double_top_bottom");
                context.startActivity(intent);
            }
    ...
    public void setLikes_un() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    // add user id to the list
                    liker_list_un.add(requireNonNull(requireNonNull(ds.child(context.getString(R.string.field_user_id)).getValue())).toString());
                    likes_count_un++;
                }
    ...
    public void setLikes_deux() {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    // add user id to the list
                    liker_list_deux.add(requireNonNull(requireNonNull(ds.child(context.getString(R.string.field_user_id)).getValue())).toString());
                    likes_count_deux++;
                }
