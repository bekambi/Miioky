...
public class GroupSharedSingleBottomImageUneDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupSharedSingleBottomImageUneDisplay(AppCompatActivity context, BattleModel mModel,
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for(DataSnapshot ds : dataSnapshot.getChildren()){
                                ...
                                relLayout_username.setOnClickListener(view -> {
                                    ...
                                    Intent intent;
                                    if (mPhoto.getUser_id().equals(user_id) && user_groups.getAdmin_master().equals(user_id)) {
