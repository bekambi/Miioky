...
public class GroupSharedTopBottomVideoDoubleDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedTopBottomVideoDoubleDisplay";
    ...
    public GroupSharedTopBottomVideoDoubleDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null, null,
                    null, null, "video_double_top_bottom", null, null, relLayout_view_overlay);
            linLayout_comment.setOnClickListener(view -> {
        ...
        linLayout_share_un.setOnClickListener(view -> {
            ...
            try {
                if (bottomSheetShare_un.isAdded())
                    return;Bundle bundle = new Bundle();
