...
import com.bekambimouen.miiokychallenge.friends.viewpager_adapter.ViewPagerAdapter;
 ...
 * Use the {@link InviteAndFollowFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InviteAndFollowFragment extends Fragment implements OnLoadMoreItemsListener {
    private static final String TAG = "InviteAndFollowFragment";

    // widgets
    private TextView number_of_invitations;
    private RecyclerView recyclerView_confirmation;
    private RelativeLayout relLayout_confirmation, relLayout_view_overlay;
    private LinearLayout linLayout_for_public_account, linLayout_for_private_account;
    // suggestion
    ...
    public InviteAndFollowFragment() {
        // Required empty public constructor
    }

    public static InviteAndFollowFragment newInstance() {
        InviteAndFollowFragment fragment = new InviteAndFollowFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_invite_and_follow, container, false);
    ...
    private void init(View v) {
        linLayout_for_private_account = v.findViewById(R.id.linLayout_for_private_account);
        linLayout_for_public_account = v.findViewById(R.id.linLayout_for_public_account);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    if (user.getScope().equals(context.getString(R.string.title_private))) {
                        linLayout_for_private_account.setVisibility(View.VISIBLE);
                    }

                    if (user.getScope().equals(context.getString(R.string.title_public))) {
                        linLayout_for_public_account.setVisibility(View.VISIBLE);
                    }
                }
            }
    ...
    private void displayTheList() {
        ...
        adapter = new SeeAllSuggestionFriendsAdapter(context, pagination, progressBar, this, relLayout_view_overlay);
    ...
    private void configureViewPagerAndTabs(View v) {
        ...
        String[] titles = {"Amis", "Abonnement"};

        new TabLayoutMediator(tabLayout_profile, viewPager, (tabLayout, position) -> tabLayout.setText(titles[position])).attach();
    ...
    private void getBadgeNotification(TabLayout tabLayout, ViewPager2 viewPager) {
        ...
        query1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (f > 0)
                    Objects.requireNonNull(tabLayout.getTabAt(0)).getOrCreateBadge().setNumber(f);
            }
        ...
        query2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (a > 0)
                    Objects.requireNonNull(tabLayout.getTabAt(1)).getOrCreateBadge().setNumber(a);
            }
