...
import com.bekambimouen.miiokychallenge.full_image_share.ResponseImageDoubleFullImageShare;
...
public class SharedResponseImageDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public SharedResponseImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                            MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            BottomSheetAddCommentShare bottomSheetFragmentShare = new BottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null,
                    null, null,
                    "response_img_double_on_miioky", null, relLayout_view_overlay);
            linLayout_comment.setOnClickListener(view -> {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (mModel != null) {
                if (from_full_image != null) {
                    ...
                    Intent intent = new Intent(context, ResponseImageDoubleFullImageShare.class);
                    Gson gson = new Gson();
                    String myGson = gson.toJson(photo);
                    intent.putExtra("battleModel_response_image_double", myGson);
                    intent.putExtra("position", 0);
                    intent.putExtra("response_img_double_on_miioky", "response_img_double_on_miioky");
