...
import com.bekambimouen.miiokychallenge.full_image.ResponseImageDoubleFullImage;
...
public class ResponseImageDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public ResponseImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            BottomSheetAddComment mSheetFragment = new BottomSheetAddComment(context, null, null, null,
                    ...
                    "response_img_double", null, relLayout_view_overlay);
            linLayout_comment.setOnClickListener(view -> {
        ...
        bottomSheetShare_un = new BottomSheetSharePublication(context, model, model.getUser_id(),
                model.getReponse_url(), model.getReponse_photoID(), "", "response_image_double",
                false);
        linLayout_share_un.setOnClickListener(view -> {
            ...
            try {
                ...
                bundle.putString("item_view", "response_image_double");
        ...
        bottomSheetShare_deux = new BottomSheetSharePublication(context, model, model.getUser_id(),
                model.getInvite_url(), model.getInvite_photoID(), "", "response_image_double",
                false);
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (mModel != null) {
                if (from_full_image != null) {
                    ...
                    Intent intent = new Intent(context, ResponseImageDoubleFullImage.class);
                    Gson gson = new Gson();
