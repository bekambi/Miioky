...
import com.bekambimouen.miiokychallenge.display_insta.suggestion_fun.adapter.VideoSuggestion_threeAdapter;
...
public class VideoSuggestion_three extends RecyclerView.ViewHolder {
    ...
    // vars
    private VideoSuggestion_threeAdapter adapter;
    ...
    public VideoSuggestion_three(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    private void displayTheList() {
        ...
        adapter = new VideoSuggestion_threeAdapter(context, finalList, relLayout_view_overlay);
