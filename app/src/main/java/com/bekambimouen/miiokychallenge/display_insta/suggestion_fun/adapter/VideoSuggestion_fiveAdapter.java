...
public class VideoSuggestion_fiveAdapter extends RecyclerView.Adapter<VideoSuggestion_fiveAdapter.ViewHolder> {
    private static final String TAG = "VideoSuggestion_fiveAdapter";

    private final AppCompatActivity context;
    private final ArrayList<BattleModel_fun> list;
    private final RelativeLayout relLayout_view_overlay;

    public VideoSuggestion_fiveAdapter(AppCompatActivity context, ArrayList<BattleModel_fun> list, RelativeLayout relLayout_view_overlay) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            intent.putExtra("position", 25 + position);
