...
public class FriendsMainSuggestion_three extends RecyclerView.ViewHolder {
    // widgets
    ...
    public FriendsMainSuggestion_three(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
