...
import com.bekambimouen.miiokychallenge.full_image_share.ImageDoubleFullImageShare;
...
public class SharedSingleTopImageDoubleDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "SharedSingleTopImageDoubleDisplay";
    ...
    public SharedSingleTopImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                             MyEditText mComment,
    ...
    public void init(BattleModel model) {
                        ...
                        if(snapshot.exists()){
                            ...
                            if(status != null && !status.isEmpty()){
                                if(status.equals(context.getString(R.string.field_offLine))){
                                    ...
                                    if (!model.getUser_id_sharing().equals(requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid()))
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot: snapshot.getChildren()) {
                    ...
                    Query query2 = myRef
                            .child(context.getString(R.string.dbname_users))
                            .orderByChild(context.getString(R.string.field_user_id))
                            .equalTo(mPhoto.getUser_id_sharing());
        ...
        if (mModel != null) {
            ...
            BottomSheetAddCommentShare bottomSheetFragmentShare = new BottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null,
                    null, null, "image_double_single_top", null,
                    null, null, null, null,
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (mModel != null) {
                if (from_full_image != null) {
                    ...
                    Intent intent = new Intent(context, ImageDoubleFullImageShare.class);
                    Gson gson = new Gson();
