...
public class GroupSharedSingleBottomRecyclerItemDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupSharedSingleBottomRecyclerItemDisplay(AppCompatActivity context, BattleModel mModel,
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    crusher_list.add(requireNonNull(requireNonNull(ds.child(context.getString(R.string.field_user_id)).getValue())).toString());
                    crush_count++;
                }
