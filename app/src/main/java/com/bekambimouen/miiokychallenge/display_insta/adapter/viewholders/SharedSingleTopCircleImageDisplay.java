...
public class SharedSingleTopCircleImageDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedSingleTopImageUneDisplay";
    ...
    public SharedSingleTopCircleImageDisplay(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    public void init(BattleModel model) {
                    ...
                    query2.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot1) {
                            for(DataSnapshot ds : snapshot1.getChildren()){
                                ...
                                String userName = user.getUsername();
                                if (!model.getGroup_user_background_profile_url().isEmpty()) {
                                    username.setText(Html.fromHtml("<b>"+userName+"</b> "+context.getString(R.string.updated_cover_user_profile)));
                                } else {
                                    username.setText(Html.fromHtml("<b>"+userName+"</b> "+context.getString(R.string.updated_cover_photo)));
                                }
        ...
        BottomSheetAddCommentShare sheetFragmentShare = new BottomSheetAddCommentShare(context,
                ...
                null, null, null, null,
                "image_une_single_top", null, null, null,
                null, null, null, null,
