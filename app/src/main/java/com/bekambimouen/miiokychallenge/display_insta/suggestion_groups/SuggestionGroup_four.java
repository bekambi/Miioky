...
public class SuggestionGroup_four extends RecyclerView.ViewHolder {
    ...
    public SuggestionGroup_four(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
