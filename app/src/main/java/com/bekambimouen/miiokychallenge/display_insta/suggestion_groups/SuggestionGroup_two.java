...
public class SuggestionGroup_two extends RecyclerView.ViewHolder {
    ...
    public SuggestionGroup_two(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
