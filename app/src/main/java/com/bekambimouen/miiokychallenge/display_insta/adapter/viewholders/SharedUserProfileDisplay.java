...
import com.bekambimouen.miiokychallenge.full_image_share.ImageUneFullImageShare;
...
public class SharedUserProfileDisplay extends RecyclerView.ViewHolder {
    ...
    public final RelativeLayout relLayout_username_shared;
    ...
    public SharedUserProfileDisplay(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    public void init(BattleModel model) {
        ...
        query1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot ds : snapshot.getChildren()){
                    ...
                    String userName = user.getUsername();
                    username_shared.setText(Html.fromHtml("<b>"+userName+"</b> "+context.getString(R.string.updated_cover_user_profile)));
        ...
        // add new comment
        BottomSheetAddCommentShare sheetFragmentShare = new BottomSheetAddCommentShare(context,
                null, null, null, null,
                model, null, null, null,
                null, null, null, null,
                null, null, "image_une_on_miioky", null,
        ...
        // share
        bottomSheetShare = new BottomSheetSharePublication(context, model, model.getUser_id(), model.getUser_full_profile_photo(),
    ...
    private final class GestureListenerLike extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            context.getWindow().setExitTransition(new Slide(Gravity.END));
            context.getWindow().setEnterTransition(new Slide(Gravity.START));
            Intent intent = new Intent(context, ImageUneFullImageShare.class);
            Gson gson = new Gson();
            String myGson = gson.toJson(mPhoto);
            intent.putExtra("battleModel_image_une", myGson);
            intent.putExtra("image_une_on_miioky", "image_une_on_miioky");
            context.startActivity(intent);
