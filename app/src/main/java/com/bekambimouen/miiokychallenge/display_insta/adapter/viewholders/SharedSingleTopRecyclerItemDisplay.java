...
public class SharedSingleTopRecyclerItemDisplay extends RecyclerView.ViewHolder {
    ...
    public SharedSingleTopRecyclerItemDisplay(AppCompatActivity context, BattleModel mModel,
                                              MyEditText mComment,
    ...
    private void gridImages(ArrayList<String> urlList) {
        ...
        if(i==5)
        {
            ...
            imageView5.setY(((float) 800/3+(float) 800/3));
