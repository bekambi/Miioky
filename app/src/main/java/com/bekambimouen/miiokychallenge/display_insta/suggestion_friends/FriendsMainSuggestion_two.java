...
public class FriendsMainSuggestion_two extends RecyclerView.ViewHolder {
    // widgets
    ...
    public FriendsMainSuggestion_two(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
