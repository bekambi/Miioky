...
public class GroupSharedSingleBottomVideoDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupSharedSingleBottomVideoDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                                     MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                    ...
                    "video_double_single_bottom", null, null, null, null,
