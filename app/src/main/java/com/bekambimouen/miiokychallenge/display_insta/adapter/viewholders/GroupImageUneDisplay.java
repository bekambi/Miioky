...
public class GroupImageUneDisplay extends RecyclerView.ViewHolder {
    ...
    private String from_group_cover;
    private String from_group_background_profile;
    ...
    public GroupImageUneDisplay(AppCompatActivity context, BattleModel mModel,
                                MyEditText mComment, String from_group_cover,
                                String from_group_background_profile, String from_full_image,
                            ...
                            for (DataSnapshot ds: snapshot.getChildren()) {
                                ...
                                if (user_groups.isGroup_private()) {
                                    ...
                                    bottomSheetShare = new BottomSheetSharePublication(context, model, model.getUser_id(), model.getUrl(),
                                            model.getPhoto_id(), "","image_une", false);
                                    linLayout_share.setOnClickListener(view -> {
                                        // prevent two clicks
                                        ...
                                        try {
                                            ...
                                            bundle.putString("item_view", "group_image_une");
