...
import com.bekambimouen.miiokychallenge.groups.full_challenge_video_share.GroupFullChallengeVideoShare;
...
public class GroupSharedTopBottomResponseVideoDoubleDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedTopBottomResponseVideoDoubleDisplay";
    ...
    public GroupSharedTopBottomResponseVideoDoubleDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
                    ...
                    query2.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            for(DataSnapshot ds : dataSnapshot.getChildren()){
                                ...
                                reponse_username.setText(user_reponse.getUsername());
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null, null,
                    null, null, null, null,
                    "response_vid_double_top_bottom", relLayout_view_overlay);
            linLayout_comment.setOnClickListener(view -> {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (mModel != null) {
                if (from_full_video != null) {
                    ...
                    Intent intent = new Intent(context, GroupFullChallengeVideoShare.class);
                    Gson gson = new Gson();
                    ...
                    intent.putExtra("response_video_double_top_bottom", "response_video_double_top_bottom");
