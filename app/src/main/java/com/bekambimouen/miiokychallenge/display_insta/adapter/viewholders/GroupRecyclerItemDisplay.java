...
public class GroupRecyclerItemDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupRecyclerItemDisplay";
    ...
    public GroupRecyclerItemDisplay(AppCompatActivity context, BattleModel mModel,
                                    MyEditText mComment, String from_full_image, RelativeLayout relLayout_view_overlay,
