...
public class GroupCoverDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupCoverDisplay";
    ...
    private final CircleImageView main_image_une;
    ...
    public GroupCoverDisplay(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    public void init(BattleModel model) {
                            ...
                            for (DataSnapshot ds: snapshot.getChildren()) {
                                ...
                                if (user_groups.isGroup_private()) {
                                    ...
                                    bottomSheetShare = new BottomSheetSharePublication(context, model, model.getUser_id(),
                                            model.getGroup_full_profile_photo(), model.getPhoto_id(),
                                            "", "image_une", false);
                                    linLayout_share.setOnClickListener(view -> {
                                        // prevent two clicks
        ...
        GroupBottomSheetAddComment mSheetFragment = new GroupBottomSheetAddComment(context,
                ...
                "from_group_cover", null, relLayout_view_overlay);
