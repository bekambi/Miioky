...
public class SuggestionGroup_three extends RecyclerView.ViewHolder {
    ...
    public SuggestionGroup_three(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
