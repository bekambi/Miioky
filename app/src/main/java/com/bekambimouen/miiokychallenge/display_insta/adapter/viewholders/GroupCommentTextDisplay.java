...
public class GroupCommentTextDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupImageUneDisplay";
    ...
    public GroupCommentTextDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddComment mSheetFragment = new GroupBottomSheetAddComment(context,
                    model, null, null, null, "comment_text",
