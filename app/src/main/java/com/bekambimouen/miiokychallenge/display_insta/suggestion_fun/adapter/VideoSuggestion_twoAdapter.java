...
public class VideoSuggestion_twoAdapter extends RecyclerView.Adapter<VideoSuggestion_twoAdapter.ViewHolder> {
    private static final String TAG = "VideoSuggestion_twoAdapter";

    private final AppCompatActivity context;
    private final ArrayList<BattleModel_fun> list;
    private final RelativeLayout relLayout_view_overlay;

    public VideoSuggestion_twoAdapter(AppCompatActivity context, ArrayList<BattleModel_fun> list, RelativeLayout relLayout_view_overlay) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            intent.putExtra("position", 7 + position);
