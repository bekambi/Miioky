...
import com.bekambimouen.miiokychallenge.groups.full_image.GroupResponseImageDoubleFullImage;
...
public class GroupResponseImageDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupResponseImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
                            ...
                            for (DataSnapshot ds: snapshot.getChildren()) {
                                ...
                                if (user_groups.isGroup_private()) {
                                    ...
                                    bottomSheetShare_un = new BottomSheetSharePublication(context, model, model.getUser_id(),
                                            model.getReponse_url(), model.getReponse_photoID(), "", "response_image_double", false);
                                    linLayout_share_un.setOnClickListener(view -> {
                                        ...
                                        try {
                                            ...
                                            bundle.putString("item_view", "group_response_image_double");
                                    ...
                                    bottomSheetShare_deux = new BottomSheetSharePublication(context, model, model.getUser_id(),
                                            model.getInvite_url(), model.getInvite_photoID(), "", "response_image_double", false);
                                    linLayout_share_deux.setOnClickListener(view -> {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddComment mSheetFragment = new GroupBottomSheetAddComment(context,
                    ...
                    null, null, null, null, "response_img_double", null,
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (mModel != null) {
                if (from_full_image != null) {
                    ...
                    Intent intent = new Intent(context, GroupResponseImageDoubleFullImage.class);
                    Gson gson = new Gson();
