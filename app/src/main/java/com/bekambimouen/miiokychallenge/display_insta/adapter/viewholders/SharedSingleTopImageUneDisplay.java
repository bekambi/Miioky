...
public class SharedSingleTopImageUneDisplay extends RecyclerView.ViewHolder {
    ...
    public SharedSingleTopImageUneDisplay(AppCompatActivity context, BattleModel mModel,
                                          MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (model.isGroup_share_single_top_circle_image()) {
            // concerning comment circle image
