...
public class GroupSharedSingleBottomImageDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupSharedSingleBottomImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                                     MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null, null, "image_double_single_bottom",
