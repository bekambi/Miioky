...
public class FriendsMainSuggestion_five extends RecyclerView.ViewHolder {
    // widgets
    ...
    public FriendsMainSuggestion_five(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
