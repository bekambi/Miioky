...
import com.bekambimouen.miiokychallenge.display_insta.suggestion_fun.adapter.VideoSuggestion_fourAdapter;
...
public class VideoSuggestion_four extends RecyclerView.ViewHolder {
    ...
    // vars
    private VideoSuggestion_fourAdapter adapter;
    ...
    public VideoSuggestion_four(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    private void displayTheList() {
        ...
        adapter = new VideoSuggestion_fourAdapter(context, finalList, relLayout_view_overlay);
