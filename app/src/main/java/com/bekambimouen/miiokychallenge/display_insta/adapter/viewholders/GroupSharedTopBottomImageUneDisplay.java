...
public class GroupSharedTopBottomImageUneDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupSharedTopBottomImageUneDisplay(AppCompatActivity context, BattleModel mModel,
