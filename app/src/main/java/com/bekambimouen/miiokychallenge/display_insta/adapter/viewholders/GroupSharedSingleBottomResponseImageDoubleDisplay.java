...
public class GroupSharedSingleBottomResponseImageDoubleDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "ResponseImageDoubleDisplay";
    ...
    public GroupSharedSingleBottomResponseImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                                             MyEditText mComment,
                                                             String from_full_image, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
