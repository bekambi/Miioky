...
import com.bekambimouen.miiokychallenge.display_insta.suggestion_fun.adapter.VideoSuggestion_fiveAdapter;
...
public class VideoSuggestion_five extends RecyclerView.ViewHolder {
    ...
    // vars
    private VideoSuggestion_fiveAdapter adapter;
    ...
    public VideoSuggestion_five(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    private void displayTheList() {
        ...
        adapter = new VideoSuggestion_fiveAdapter(context, finalList, relLayout_view_overlay);
