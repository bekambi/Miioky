...
public class GroupSharedTopBottomImageDoubleDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedTopBottomImageDoubleDisplay";
    ...
    public GroupSharedTopBottomImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null, null,
                    null, "image_double_top_bottom", null, null, null, relLayout_view_overlay);
            linLayout_comment.setOnClickListener(view -> {
