...
public class GroupCoverBackProfileDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupCoverBackProfileDisplay(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
                            ...
                            for (DataSnapshot ds: snapshot.getChildren()) {
                                ...
                                if (user_groups.isGroup_private()) {
                                    ...
                                    bottomSheetShare = new BottomSheetSharePublication(context, model, model.getUser_id(),
                                            model.getGroup_user_background_full_profile_url(), model.getPhoto_id(),
                                            "", "image_une", false);
                                    linLayout_share.setOnClickListener(view -> {
                                        // prevent two clicks
