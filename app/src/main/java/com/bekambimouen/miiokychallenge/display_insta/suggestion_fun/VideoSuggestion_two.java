...
import com.bekambimouen.miiokychallenge.display_insta.suggestion_fun.adapter.VideoSuggestion_twoAdapter;
...
public class VideoSuggestion_two extends RecyclerView.ViewHolder {
    ...
    // vars
    private VideoSuggestion_twoAdapter adapter;
    ...
    public VideoSuggestion_two(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    private void displayTheList() {
        ...
        adapter = new VideoSuggestion_twoAdapter(context, finalList, relLayout_view_overlay);
