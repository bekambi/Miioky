...
public class SharedImageUneDisplay extends RecyclerView.ViewHolder {
    ...
    public SharedImageUneDisplay(AppCompatActivity context, BattleModel mModel,
                                 MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (model.isUser_profile_shared()) {
            // from comment
