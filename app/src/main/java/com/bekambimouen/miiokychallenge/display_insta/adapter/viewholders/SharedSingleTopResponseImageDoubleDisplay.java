...
public class SharedSingleTopResponseImageDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public SharedSingleTopResponseImageDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                                     MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            BottomSheetAddCommentShare bottomSheetFragmentShare = new BottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null,
                    null, null, null, null,
                    "response_img_double_single_top", null, null, null,
