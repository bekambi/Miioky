...
public class GroupVideoUneDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupVideoUneDisplay";
    ...
    public GroupVideoUneDisplay(AppCompatActivity context, BattleModel mModel,
