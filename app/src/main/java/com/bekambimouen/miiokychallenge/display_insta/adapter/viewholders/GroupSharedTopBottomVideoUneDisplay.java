...
public class GroupSharedTopBottomVideoUneDisplay extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedTopBottomVideoUneDisplay";
    ...
    public GroupSharedTopBottomVideoUneDisplay(AppCompatActivity context, BattleModel mModel,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                    ...
                    "video_une_top_bottom", null, null,
