...
public class SharedSingleTopVideoDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public SharedSingleTopVideoDoubleDisplay(AppCompatActivity context, BattleModel mModel,
                                             MyEditText mComment,
    ...
    public void init(BattleModel model) {
        ...
        if (mModel != null) {
            ...
            BottomSheetAddCommentShare bottomSheetFragmentShare = new BottomSheetAddCommentShare(context,
                    ...
                    null, null, null, null,
                    null, null, null, "video_double_single_top",
                    null, null, null, null,
