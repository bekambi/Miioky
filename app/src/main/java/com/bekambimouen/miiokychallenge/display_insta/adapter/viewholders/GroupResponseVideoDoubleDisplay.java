...
public class GroupResponseVideoDoubleDisplay extends RecyclerView.ViewHolder {
    ...
    public GroupResponseVideoDoubleDisplay(AppCompatActivity context, BattleModel mModel,
