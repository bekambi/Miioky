package com.bekambimouen.miiokychallenge.market_place.comment.store_comment.adapter;
...
import com.bekambimouen.miiokychallenge.market_place.comment.store_comment.adapter.viewholder.StoreViewHolderComment;
...
public class StoreCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StoreCommentAdapter(AppCompatActivity context, ArrayList<Comment> list, MarketModel marketModel,
                               MarketCommentListener marketCommentListener,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new StoreViewHolderComment(context, marketModel, marketCommentListener, "from_bottom_sheet", relLayout_view_overlay, view);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        StoreViewHolderComment productViewHolderComment = (StoreViewHolderComment) holder;
