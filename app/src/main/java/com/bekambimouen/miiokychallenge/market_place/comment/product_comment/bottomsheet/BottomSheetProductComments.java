package com.bekambimouen.miiokychallenge.market_place.comment.product_comment.bottomsheet;
...
import com.bekambimouen.miiokychallenge.market_place.comment.product_comment.ProductResponseComment;
import com.bekambimouen.miiokychallenge.market_place.comment.product_comment.adapter.ProductCommentAdapter;
...
public class BottomSheetProductComments extends BottomSheetDialogFragment implements OnLoadMoreItemsListener {
    ...
    public BottomSheetProductComments(AppCompatActivity context, MarketModel market_model, RelativeLayout relLayout_view_overlay) {
    ...
    private void init() {
        ...
        marketCommentListener = (commentKey, comment, user_id, url, thumbnail, commentModel, time) -> {
            ...
            context.getWindow().setExitTransition(new Slide(Gravity.END));
            context.getWindow().setEnterTransition(new Slide(Gravity.START));
            Intent intent = new Intent(context, ProductResponseComment.class);
    ...
    private void setupWidgets(MarketModel marketModel) {
        ...
        adapter = new ProductCommentAdapter(context, pagination, marketModel, marketCommentListener, loading_progressBar,
    ...
    private void getResponseComment(MarketModel marketModel) {
        ...
        Query query = myRef
                ...
                .equalTo(marketModel.getPhotoi_id());
