package com.bekambimouen.miiokychallenge.market_place.comment.product_comment.publication;
...
public class ProductCommentPublication extends AppCompatActivity {
    private static final String TAG = "MarketCommentPublication";

    // video publication ____________________________________________________________________
    // widgets
    private RelativeLayout relLayout_select_video, relLayout_img_play, relLayout_view_overlay;
    ...
    //widgets
    private RelativeLayout parent, relLayout_download_photo_and_video;
    private LinearLayout linLayout_select_photo;
    private RecyclerView recyclerView;

    //vars
    private ProductCommentPublication context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_comment_publication);
        context = this;
    ...
    private void initImage() {
        ...
        arrowBack_photo.setOnClickListener(v -> {
    ...
    private void uploadNewVideo(String videoUrl, String caption) {
        ...
        StorageReference thumbnailReference = mStorageReference
                .child(filePaths.FIREBASE_STORAGE_MARKET_COMMENT + "/"
                        + user_id + "/video/"+ calendar.getTimeInMillis() + thumbnailUri.getLastPathSegment());
        ...
        uploadTask.continueWithTask(task1 -> {
            ...
            if (task1.isSuccessful()) {
                ...
                StorageReference videoReference = mStorageReference
                        .child(filePaths.FIREBASE_STORAGE_MARKET_COMMENT + "/"
                                + user_id + "/video/"+ calendar.getTimeInMillis() + videoUri.getLastPathSegment());
    ...
    private void uploadOnePhotoWithoutCompress(final String caption, Uri imageUri) {
        ...
        StorageReference storageReference = mStorageReference
                .child(filePaths.FIREBASE_STORAGE_MARKET_COMMENT + "/" + user_id + "/" + calendar.getTimeInMillis());
