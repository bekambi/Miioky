...
public class StoreItemsAdapter extends RecyclerView.Adapter<StoreItemsAdapter.MyViewHolder> {
    private static final String TAG = "StoreItemsAdapter";

    private final AppCompatActivity context;
    private final List<MarketModel> list;
    private final ProgressBar progressBar, progressBar_to_rent_out;
    private final RelativeLayout relLayout_view_overlay;

    public StoreItemsAdapter(AppCompatActivity context, List<MarketModel> list, ProgressBar progressBar,
