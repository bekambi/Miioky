package com.bekambimouen.miiokychallenge.market_place.comment.store_comment;
...
import com.bekambimouen.miiokychallenge.market_place.comment.store_comment.coment_response.adapter.StoreCommentResponseAdapter;
...
public class StoreResponseComment extends AppCompatActivity implements OnLoadMoreItemsListener {
    ...
    // vars
    private StoreResponseComment context;
    private StoreCommentResponseAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_store_response_comment);
        context = this;
        ...
        if (!TextUtils.isEmpty(newComment)) {
            if (market_model != null) {
                if (isInResponseTo) {
                    ...
                    addNewChildResponseComment(market_model, requireNonNull(mComment.getText()).toString(), comment_key, mUsername);
                    ...
                    Log.d(TAG, "onClick: attempting to submit new response comment.");
                    addNewResponseComment(market_model, requireNonNull(mComment.getText()).toString(), comment_key);
    ...
    private void getAdapter() {
        adapter = new StoreCommentResponseAdapter(context, pagination, market_model,
    ...
    private void addNewResponseComment(MarketModel marketModel, String newComment, String commentKey){
    ...
    private void addNewChildResponseComment(MarketModel marketModel, String newComment, String commentKey, String username){
        Log.d(TAG, "addNewComment: adding new comment: " + newComment);
        String commentID = myRef.push().getKey();
