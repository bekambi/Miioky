...
public class VisitProfileAdapter extends RecyclerView.Adapter<VisitProfileAdapter.MyViewHolder>
        implements Filterable {
    private static final String TAG = "VisitProfileAdapter";

    private OnLoadMoreItemsListener mOnLoadMoreItemsListener;
    private final ProgressBar progressBar;
    // vars
    private final AppCompatActivity context;
    private final ArrayList<VisitProfileModel> userList;
    public List<VisitProfileModel> userListFiltered;
    private final RelativeLayout relLayout_view_overlay;
    // vars
    private String string_username, string_fullName, string2;

    public VisitProfileAdapter(AppCompatActivity context, ArrayList<VisitProfileModel> userList,
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.layout_visit_profile, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        VisitProfileModel user = userListFiltered.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    List<VisitProfileModel> filteredList = new ArrayList<>();
                    for (VisitProfileModel row : userList) {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                userListFiltered = (ArrayList<VisitProfileModel>) filterResults.values;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        // widgets
        private final RelativeLayout relLayout_profile_friends, relLayout_member_ii, relLayout_unfriend,
                relLayout_follow, relLayout_all_buttons;
        private final LinearLayout linLayout_username;
        private final CircleImageView profile_photo, member_i, member_ii;
        private final TextView views, last_date, username, full_name, button_follow, button_sent,
        ...
        private VisitProfileModel visit_mUser;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            getTheUserFriendsList();
        }

        void bindView(VisitProfileModel visit_user) {
            visit_mUser = visit_user;

            views.setText(Html.fromHtml(visit_user.getViews()+" "+context.getString(R.string.time)));
            long tv_date = visit_user.getDate_last_profile_visit();
            long time = (System.currentTimeMillis() - tv_date);
            if (time >= 2*3600*24000254025L)
                last_date.setText(Html.fromHtml(context.getString(R.string.last_visit)+" "+ context.getString(R.string.the)+" "+ TimeUtils.getTime(context, tv_date)));
            else
                last_date.setText(Html.fromHtml(context.getString(R.string.last_visit)+" "+ context.getString(R.string.there_is)+" "+ TimeUtils.getTime(context, tv_date)));

            //get the profile image and username
            Query query = myRef
                    .child(context.getString(R.string.dbname_users))
                    .orderByChild(context.getString(R.string.field_user_id))
                    .equalTo(visit_mUser.getUser_id());
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for(DataSnapshot ds : dataSnapshot.getChildren()){
                        ...
                        // verify and update username if it has been update
                        if (!visit_user.getUsername().equals(user.getUsername()) || !visit_user.getFullName().equals(user.getFullName())) {
                            HashMap<String, Object> map = new HashMap<>();
                            if (!visit_user.getFullName().equals(user.getFullName()))
                                map.put(context.getString(R.string.field_fullName), user.getFullName());
                            if (!visit_user.getUsername().equals(user.getUsername()))
                                map.put(context.getString(R.string.field_username), user.getUsername());

                            myRef.child(context.getString(R.string.dbname_visit_profile))
                                    .child(user_id)
        ...
        // get the common friends
        private void getTheUserFriendsList() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (t != 0)
                                if (!visit_mUser.getUser_id().equals(user_id))
