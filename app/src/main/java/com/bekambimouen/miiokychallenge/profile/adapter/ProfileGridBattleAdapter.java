...
public class ProfileGridBattleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "ProfileGridBattleAdapter";
    ...
    public ProfileGridBattleAdapter(AppCompatActivity context, List<BattleModel> list, RelativeLayout relLayout_view_overlay) {
