package com.bekambimouen.miiokychallenge.groups.comment_share.publication;
...
public class GroupCommentSharePublication extends AppCompatActivity {
    private static final String TAG = "GroupCommentSharePublication";
    ...
    //vars
    private GroupCommentSharePublication context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_comment_share_publication);
        context = this;
