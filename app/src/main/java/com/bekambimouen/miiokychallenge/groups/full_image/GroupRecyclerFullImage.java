...
import com.bekambimouen.miiokychallenge.groups.child_recyclerview.bottomsheet.GroupBottomSheetAddRecyclerImageDescription;
...
public class GroupRecyclerFullImage extends AppCompatActivity {
    private static final String TAG = "GroupRecyclerFullImage";
    ...
    // vars
    private GroupRecyclerFullImage context;
    ...
    private GroupBottomSheetAddRecyclerImageDescription bottomSheetAddRecyclerImageDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_recycler_full_image);
        context = this;
        getBlackTheme();
    ...
    private void fullImage(int position) {
        ...
        if (model.getUser_id().equals(user_id)) {
            ...
            bottomSheetAddRecyclerImageDescription =
                    new GroupBottomSheetAddRecyclerImageDescription(context, model,
