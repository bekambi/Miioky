package com.bekambimouen.miiokychallenge.groups.child_recyclerview_share.comment.comment_response;
...
public class GroupViewHolderShareResponse_recycler_child extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupViewHolderShareResponse_recycler_child";
    ...
    private final String recyclerview_photo_id, recyclerview_fieldLike, comment_key;
    ...
    public GroupViewHolderShareResponse_recycler_child(AppCompatActivity context, BattleModel model, String recyclerview_photo_id,
                                                       String recyclerview_fieldLike, String comment_key, ChildItemClickListener mChildItemClickListener,
