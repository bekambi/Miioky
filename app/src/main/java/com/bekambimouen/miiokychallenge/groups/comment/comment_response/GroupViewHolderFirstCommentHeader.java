...
public class GroupViewHolderFirstCommentHeader extends RecyclerView.ViewHolder {
    ...
    public GroupViewHolderFirstCommentHeader(AppCompatActivity context, BattleModel model, BattleModel comment_recycler_child,
                ...
                for ( DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    comment_profile_image.setOnClickListener(v -> {
                        ...
                        if (user.getUser_id().equals(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser()).getUid())) {
                            ...
                            Gson gson = new Gson();
                            String myJson = gson.toJson(userID);
