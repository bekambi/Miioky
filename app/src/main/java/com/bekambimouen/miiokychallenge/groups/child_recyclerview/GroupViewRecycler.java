package com.bekambimouen.miiokychallenge.groups.child_recyclerview;
...
import com.bekambimouen.miiokychallenge.groups.child_recyclerview.adapter.GroupViewRecyclerAdapter;
...
public class GroupViewRecycler extends AppCompatActivity {
    private static final String TAG = "GroupViewRecycler";
    // widgets
    ...
    // vars
    private GroupViewRecycler context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_view_recycler);
        context = this;
    ...
    private void getData() {
        if (battleModel != null) {
            ...
            GroupViewRecyclerAdapter adapter = new GroupViewRecyclerAdapter(context, listUrl, battleModel, isFrom_approval_post,
