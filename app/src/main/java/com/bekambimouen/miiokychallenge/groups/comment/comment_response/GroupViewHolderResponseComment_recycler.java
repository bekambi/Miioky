package com.bekambimouen.miiokychallenge.groups.comment.comment_response;
...
public class GroupViewHolderResponseComment_recycler extends RecyclerView.ViewHolder {
    private static final String TAG = "ViewHolderResponseComment_recycler";
    ...
    public GroupViewHolderResponseComment_recycler(AppCompatActivity context, BattleModel model, String comment_key,
                                                   ChildItemClickListener mChildItemClickListener, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
