package com.bekambimouen.miiokychallenge.groups.manage_member.post_approval;
...
import com.bekambimouen.miiokychallenge.groups.manage_member.post_approval.adapter.WaitingApprovalPostAdapter;
...
public class GroupWaitingApproval extends AppCompatActivity implements OnLoadMoreItemsListener {
    private static final String TAG = "WaittingApproval";

    // widgets
    private RecyclerView recyclerView;
    private ProgressBar progressBar, loading_progressBar;
    private RelativeLayout parent, relLayout_no_waiting_for_approval, relLayout_view_overlay;
    ...
    // vars
    private GroupWaitingApproval context;
    private WaitingApprovalPostAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_waiting_approval);
        context = this;
    ...
    private void init() {
        ...
        relLayout_no_waiting_for_approval = findViewById(R.id.relLayout_no_waiting_for_approval);
        ...
        toolBar_textview.setText(context.getString(R.string.awaiting_approval));
    ...
    private void displayPhotos() {
        if (list != null) {
            try {
                ...
                adapter = new WaitingApprovalPostAdapter(context, list,
                        user_groups, this, progressBar, loading_progressBar, relLayout_view_overlay);
                recyclerView.setAdapter(adapter);

                if (adapter.getItemCount() == 0) {
                    progressBar.setVisibility(View.GONE);
                    relLayout_no_waiting_for_approval.setVisibility(View.VISIBLE);
                }
