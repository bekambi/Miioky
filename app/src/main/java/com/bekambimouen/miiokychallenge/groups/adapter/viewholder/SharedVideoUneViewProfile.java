...
public class SharedVideoUneViewProfile extends RecyclerView.ViewHolder {
    ...
    public SharedVideoUneViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
