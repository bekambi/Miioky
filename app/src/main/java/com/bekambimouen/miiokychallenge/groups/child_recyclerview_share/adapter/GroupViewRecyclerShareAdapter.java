package com.bekambimouen.miiokychallenge.groups.child_recyclerview_share.adapter;
...
import com.bekambimouen.miiokychallenge.groups.full_image_share.GroupRecyclerFullImageShare;
...
public class GroupViewRecyclerShareAdapter extends RecyclerView.Adapter<GroupViewRecyclerShareAdapter.ViewHolder> {
    private static final String TAG = "GroupViewRecyclerAdapter";
    ...
    public GroupViewRecyclerShareAdapter(AppCompatActivity context, List<String> list,
    ...
    @NonNull
    @Override
    public GroupViewRecyclerShareAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull GroupViewRecyclerShareAdapter.ViewHolder holder, int position) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(String url, int position) {
            ...
            linLayout_comment.setOnClickListener(view -> {
                ...
                Intent intent = new Intent(context, GroupChildRecyclerCommentShare.class);
        ...
        private final class GestureListenerLike extends GestureDetector.SimpleOnGestureListener {
            ...
            public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
                ...
                context.getWindow().setExitTransition(new Slide(Gravity.END));
                context.getWindow().setEnterTransition(new Slide(Gravity.START));
                Intent intent = new Intent(context, GroupRecyclerFullImageShare.class);
                Gson gson = new Gson();
                String myGson = gson.toJson(battleModel);
