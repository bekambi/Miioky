package com.bekambimouen.miiokychallenge.groups.child_recyclerview_share.comment.recycler_child_img;
...
public class GroupViewHolderCommentShareRecyclerChild extends RecyclerView.ViewHolder {
    ...
    public GroupViewHolderCommentShareRecyclerChild(AppCompatActivity context, BattleModel battleModel, String recyclerview_photo_id,
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for ( DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    see_comments.setOnClickListener(view -> {
                        ...
                        context.getWindow().setExitTransition(new Slide(Gravity.END));
                        context.getWindow().setEnterTransition(new Slide(Gravity.START));
                        Intent intent = new Intent(context, GroupChildRecyclerResponseCommentShare.class);
