package com.bekambimouen.miiokychallenge.groups.full_challenge_video;
...
public class GroupFullChallengeVideo extends AppCompatActivity {
    private static final String TAG = "GroupFullChallengeVideo";
    ...
    // vars
    private GroupFullChallengeVideo context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_full_challenge_video);
        context = this;
        getBlackTheme();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    String profil = user_reponse.getProfileUrl();
                    String name = user_reponse.getUsername();
                    ...
                    challengeList.add(new ChallengeModel(profil, model.getUrlUn(), model.getThumbnail_un(), model.getPhoto_id_un(),
                            ...
                            model.getUser_id(), user_reponse, model.getDate_created(), model.getCountry_name(), model.getCountryID()));
    ...
    private void getData(int position) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    Query query4 = myRef
                            ...
                            .child(battleModel.getAdmin_master())
        ...
        bottomSheetShare = new BottomSheetSharePublication(context, null, battleModel.getUser_id(), challengeList.get(position).getUrl(),
                photo_id_list.get(position), "from_video", "", false);
