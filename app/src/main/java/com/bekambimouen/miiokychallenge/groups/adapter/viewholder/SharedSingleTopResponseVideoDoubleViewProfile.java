...
public class SharedSingleTopResponseVideoDoubleViewProfile extends RecyclerView.ViewHolder {
    ...
    public SharedSingleTopResponseVideoDoubleViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
