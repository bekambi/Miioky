...
public class SeeGroupAllProfileAdapter extends RecyclerView.Adapter<SeeGroupAllProfileAdapter.ViewHolder> {
    ...
    public SeeGroupAllProfileAdapter(AppCompatActivity context, List<BattleModel> list, RelativeLayout relLayout_view_overlay) {
