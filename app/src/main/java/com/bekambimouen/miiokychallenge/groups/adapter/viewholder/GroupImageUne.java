...
public class GroupImageUne extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupImageUne";
    ...
    public GroupImageUne(AppCompatActivity context, boolean isFrom_approval_post,
