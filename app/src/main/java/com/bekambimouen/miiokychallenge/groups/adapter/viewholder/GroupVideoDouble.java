...
public class GroupVideoDouble extends RecyclerView.ViewHolder {
    ...
    public GroupVideoDouble(AppCompatActivity context, boolean isFrom_approval_post, boolean isReportPost, String from_profile_member,
