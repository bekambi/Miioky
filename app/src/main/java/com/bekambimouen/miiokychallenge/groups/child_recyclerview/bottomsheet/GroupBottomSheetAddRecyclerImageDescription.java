package com.bekambimouen.miiokychallenge.groups.child_recyclerview.bottomsheet;
...
public class GroupBottomSheetAddRecyclerImageDescription extends BottomSheetDialogFragment {
    // widgets
    ...
    public GroupBottomSheetAddRecyclerImageDescription(AppCompatActivity context, BattleModel model,
