...
public class SharedResponseVideoDoubleViewProfile extends RecyclerView.ViewHolder {
    ...
    public SharedResponseVideoDoubleViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
    ...
    public void init(BattleModel model) {
                ...
                for(DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    relLayout_go_user_profile_un.setOnClickListener(v -> {
                        ...
                        if (relLayout_view_overlay != null)
                            relLayout_view_overlay.setVisibility(View.VISIBLE);
                        Intent intent;
                        if (user_reponse.getUser_id().equals(requireNonNull(requireNonNull(FirebaseAuth.getInstance().getCurrentUser())).getUid())) {
        ...
        GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                ...
                null, null, "response_vid_double_single_bottom", null, null,
                null, null, null, null,
    ...
    private final class GestureListenerLike_un extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            intent.putExtra("response_video_double_single_bottom", "response_video_double_single_bottom");
