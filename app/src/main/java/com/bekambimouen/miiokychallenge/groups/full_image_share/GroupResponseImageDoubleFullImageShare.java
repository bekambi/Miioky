...
public class GroupResponseImageDoubleFullImageShare extends AppCompatActivity {
    private static final String TAG = "GroupResponseImageDoubleFullImageShare";
    ...
    // vars
    private GroupResponseImageDoubleFullImageShare context;
    ...
    // single bottom
    private String response_img_double_single_bottom;
    // top bottom
    private String response_img_double_top_bottom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_response_image_double_full_image_share);
        context = this;
        getBlackTheme();
                    ...
                    myQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            for (DataSnapshot dataSnapshot: snapshot.getChildren()) {
                                ...
                                // the top and the bootom is in group
                                if (model.isGroup_share_top_bottom_response_image_double()) {
                                ...
                                // the bootom is on Miioky
                                if (model.isGroup_share_single_bottom_response_image_double()) {
