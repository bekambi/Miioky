...
public class GroupViewHolderCommentRecycler extends RecyclerView.ViewHolder {
    ...
    public GroupViewHolderCommentRecycler(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
