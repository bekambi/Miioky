...
public class GroupImageDoubleFullImage extends AppCompatActivity {
    private static final String TAG = "GroupImageDoubleFullImage";
    ...
    // vars
    private GroupImageDoubleFullImage context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_image_double_full_image);
        context = this;
        getBlackTheme();
        ...
        if (model != null) {
            ...
            setComments(model.getPhoto_id_un());
