...
public class GroupChooseFollowersToSendChallengeAdapter extends RecyclerView.Adapter<GroupChooseFollowersToSendChallengeAdapter.ViewHolder>
    ...
    public GroupChooseFollowersToSendChallengeAdapter(AppCompatActivity context, List<User> userList, ProgressBar loading_progressBar) {
    ...
    public void setOnItemClickListener(OnItemClickListener onItemClickListener) {
        GroupChooseFollowersToSendChallengeAdapter.onItemClickListener = onItemClickListener;
    }
