...
public class GroupViewHolderCommentRespImgDouble extends RecyclerView.ViewHolder {
    ...
    public GroupViewHolderCommentRespImgDouble(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
