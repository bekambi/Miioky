...
public class SharedSingleTopResponseImageDoubleViewProfile extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupSharedSingleTopResponseImageDoubleDisplay";
    ...
    public SharedSingleTopResponseImageDoubleViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
    ...
    public void init(BattleModel model) {
        ...
        GroupBottomSheetAddCommentShare bottomSheetFragmentShare = new GroupBottomSheetAddCommentShare(context,
                ...
                null, null, null, null, null,
                null, null, null, "response_img_double_top_bottom",
