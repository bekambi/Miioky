package com.bekambimouen.miiokychallenge.groups.comment.viewholder;
...
public class GroupViewHolderCommentImageDouble extends RecyclerView.ViewHolder {
    ...
    public GroupViewHolderCommentImageDouble(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
            ...
            query1.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot ds: snapshot.getChildren()) {
                        ...
                        if (!commentsResponseList.get(0).getUrl().equals("")) {
                            cardView_first_comment.setVisibility(View.VISIBLE);
                            if (commentsResponseList.get(0).getThumbnail().equals("")) {
                                if (!context.isFinishing()) {
                                    Glide.with(context.getApplicationContext())
                                            .asBitmap()
