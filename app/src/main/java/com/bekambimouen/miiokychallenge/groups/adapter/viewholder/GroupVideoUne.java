...
import com.bekambimouen.miiokychallenge.view_videos.ViewVideo;
...
public class GroupVideoUne extends RecyclerView.ViewHolder {
    private static final String TAG = "VideoUneDisplay";
    ...
    public GroupVideoUne(AppCompatActivity context, boolean isFrom_approval_post, boolean isReportPost, String from_profile_member,
        ...
        thumbnail.setOnTouchListener((view, motionEvent) -> mDetectorLike.onTouchEvent(motionEvent));
    }
    ...
    private final class GestureListenerLike extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            if (isFrom_approval_post) {
                ...
                intent.putExtra("video_url", photo.getUrl());
            } else {
                intent = new Intent(context, ViewVideo.class);
                Gson gson = new Gson();
                String myGson = gson.toJson(photo);
                intent.putExtra("video", myGson);
            }
    ...
    public void init(BattleModel model) {
        ...
        String description = photo.getCaption();
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            for (DataSnapshot ds: snapshot.getChildren()) {
                                ...
                                if (user_groups.isGroup_private()) {
                                    ...
                                    // share
                                    bottomSheetShare = new BottomSheetSharePublication(context, model, model.getUser_id(),
                                            model.getUrl(), model.getPhoto_id(), "from_video", "video_une", false);
                                    linLayout_share.setOnClickListener(view -> {
                                        ...
                                        try {
                                            ...
                                            bundle.putString("item_view", "group_video_une");
        ...
        GroupBottomSheetAddComment mSheetFragment = new GroupBottomSheetAddComment(context,
                ...
                null, "video_une", null, null, null, null,
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot dataSnapshot: snapshot.getChildren()) {
                    ...
                    String group_id = user_groups.getGroup_id();
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            for (DataSnapshot dataSnapshot: snapshot.getChildren()) {
                                ...
                                if (user_id.equals(model.getPublisher()) && follower.isAdminInGroup())
                                    relLayout_tv_admin.setVisibility(View.VISIBLE);
                            }
                        }
