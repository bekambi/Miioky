...
public class SharedSingleTopRecyclerItemViewProfile extends RecyclerView.ViewHolder {
    ...
    public SharedSingleTopRecyclerItemViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
    ...
    public void addNewLike(){
        ...
        myRef.child(context.getString(R.string.dbname_group_media_share))
                .child(mPhoto.getPhoto_id()) // we must use a new photo_id From recyclerview
                .child(context.getString(R.string.field_likes_share))
                .child(newLikeID)
                .setValue(like);
