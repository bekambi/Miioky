...
public class SharedVideoDoubleViewProfile extends RecyclerView.ViewHolder {
    ...
    public SharedVideoDoubleViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
