...
import com.bekambimouen.miiokychallenge.groups.child_recyclerview_share.bottomsheet.GroupBottomSheetAddRecyclerImageDescriptionShare;
...
public class GroupRecyclerFullImageShare extends AppCompatActivity {
    private static final String TAG = "GroupRecyclerFullImageShare";
    ...
    // vars
    private GroupRecyclerFullImageShare context;
    ...
    private GroupBottomSheetAddRecyclerImageDescriptionShare bottomSheetAddRecyclerImageDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_recycler_full_image_share);
        context = this;
        getBlackTheme();
    ...
    private void fullImage(int position) {
        ...
        if (model.getUser_id_sharing().equals(user_id)) {
            ...
            bottomSheetAddRecyclerImageDescription =
                    new GroupBottomSheetAddRecyclerImageDescriptionShare(context, model,
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    // if is single bottom the bottom is not the group
                    if (model.isGroup_share_single_bottom_recycler()) {
                        // single bottom
                        relLayout_username.setOnClickListener(view -> {
                            Log.d(TAG, "onClick: navigating to profile of: " + user.getUsername());
        ...
        linLayout_share.setOnClickListener(view -> {
            ...
            try {
                ...
                bundle.putBoolean("group_recycler", true);
