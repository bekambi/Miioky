...
public class FolderGroupVideosAdapter extends RecyclerView.Adapter<FolderGroupVideosAdapter.ViewHolder> {
    ...
    public FolderGroupVideosAdapter(Context context, List<FolderItem> folderList, GroupVideoListAdapter videoAdapter,
