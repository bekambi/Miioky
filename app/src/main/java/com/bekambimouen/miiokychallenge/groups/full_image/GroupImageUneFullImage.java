...
public class GroupImageUneFullImage extends AppCompatActivity {
    private static final String TAG = "GroupImageUneFullImage";
    // widgets
    ...
    // vars
    private GroupImageUneFullImage context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_image_une_full_image);
        context = this;
        getBlackTheme();
