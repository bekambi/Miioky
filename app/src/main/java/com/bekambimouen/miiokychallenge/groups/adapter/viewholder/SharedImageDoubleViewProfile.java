...
public class SharedImageDoubleViewProfile extends RecyclerView.ViewHolder {
    private static final String TAG = "SharedImageDoubleViewProfile";
    ...
    public SharedImageDoubleViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
