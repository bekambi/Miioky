...
public class SharedSingleTopCircleImageViewProfile extends RecyclerView.ViewHolder {
    ...
    public SharedSingleTopCircleImageViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
