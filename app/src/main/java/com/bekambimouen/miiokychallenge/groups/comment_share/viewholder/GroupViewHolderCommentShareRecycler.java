...
public class GroupViewHolderCommentShareRecycler extends RecyclerView.ViewHolder {
    ...
    public GroupViewHolderCommentShareRecycler(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
