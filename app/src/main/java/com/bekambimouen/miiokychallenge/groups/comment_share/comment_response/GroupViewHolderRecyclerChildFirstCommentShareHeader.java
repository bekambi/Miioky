...
public class GroupViewHolderRecyclerChildFirstCommentShareHeader extends RecyclerView.ViewHolder {
    ...
    public GroupViewHolderRecyclerChildFirstCommentShareHeader(AppCompatActivity context, BattleModel model, Comment commentModel,
