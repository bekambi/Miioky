package com.bekambimouen.miiokychallenge.groups.comment.adapter.img_and_vid_double;
...
import com.bekambimouen.miiokychallenge.groups.comment.viewholder.GroupViewHolderCommentImageDouble;
...
public class GroupCommentVideoDoubleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GroupCommentVideoDoubleAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_group_videodouble_item, parent, false);
            return new GroupVideoDoubleDisplay(context, battleModel, mComment, from_full_video, relLayout_view_overlay, view);
