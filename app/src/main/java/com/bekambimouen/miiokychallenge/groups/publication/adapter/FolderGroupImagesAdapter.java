...
public class FolderGroupImagesAdapter extends RecyclerView.Adapter<FolderGroupImagesAdapter.ViewHolder> {
    ...
    public FolderGroupImagesAdapter(Context context, List<FolderItem> folderList, GroupImageAdapter imageAdapter,
                                    ArrayList<ImageModel> imageList, Dialog dialog, TextView toolBar_textview,
