...
import com.bekambimouen.miiokychallenge.groups.child_recyclerview_share.comment.recycler_child_img.adapter.GroupCommentShareRecyclerChildAdapter;
...
public class GroupChildRecyclerCommentShare extends AppCompatActivity {
    private static final String TAG = "GroupChildRecyclerCommentShare";
    ...
    // vars
    private GroupChildRecyclerCommentShare context;
    private GroupCommentShareRecyclerChildAdapter recycler_child_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_child_recycler_comment_share);
        context = this;
    ...
    private void downloadComment() {
        if(!requireNonNull(mComment.getText()).toString().equals("")){
    ...
    private void setupWidgets(BattleModel battleModel){
        ...
        recycler_child_adapter = new GroupCommentShareRecyclerChildAdapter(context, commentsList,
