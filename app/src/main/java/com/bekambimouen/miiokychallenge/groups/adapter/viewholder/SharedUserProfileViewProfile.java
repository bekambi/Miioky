...
public class SharedUserProfileViewProfile extends RecyclerView.ViewHolder {
    ...
    public SharedUserProfileViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
        ...
        query1.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    username_shared.setText(Html.fromHtml("<b>"+user.getUsername()+"</b> "+context.getString(R.string.updated_cover_user_profile)));
