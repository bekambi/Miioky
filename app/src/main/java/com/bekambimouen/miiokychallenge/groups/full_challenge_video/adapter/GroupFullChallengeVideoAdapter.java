package com.bekambimouen.miiokychallenge.groups.full_challenge_video.adapter;
...
public class GroupFullChallengeVideoAdapter extends RecyclerView.Adapter<GroupFullChallengeVideoAdapter.MyViewHolder> {
    private static final String TAG = "GroupFullChallengeVideoAdapter";
    ...
    public GroupFullChallengeVideoAdapter(AppCompatActivity context, List<ChallengeModel> list,
