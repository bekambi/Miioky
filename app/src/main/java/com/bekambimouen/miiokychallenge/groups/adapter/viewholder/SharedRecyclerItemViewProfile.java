...
public class SharedRecyclerItemViewProfile extends RecyclerView.ViewHolder {
    ...
    public SharedRecyclerItemViewProfile(AppCompatActivity context, boolean isFrom_approval_post,
