package com.bekambimouen.miiokychallenge.groups.child_recyclerview.adapter;
...
import com.bekambimouen.miiokychallenge.groups.full_image.GroupRecyclerFullImage;
...
public class GroupViewRecyclerAdapter extends RecyclerView.Adapter<GroupViewRecyclerAdapter.RecyclerItems> {
    // vars
    ...
    public GroupViewRecyclerAdapter(AppCompatActivity context, List<String> list,
                                    BattleModel battleModel, boolean isFrom_approval_post,
    ...
    @NonNull
    @Override
    public RecyclerItems onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.layout_view_recyclerview, parent, false);
        return new RecyclerItems(relLayout_view_overlay, view);
    }

    @Override
    public void onBindViewHolder(RecyclerItems holder, int position) {
        String url = list.get(position);
        holder.bindView(url, position);
    ...
    public class RecyclerItems extends RecyclerView.ViewHolder {
        private static final String TAG = "RecyclerItems";
        // widgets
        ...
        public RecyclerItems(RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
            super(itemView);
            this.relLayout_view_overlay = relLayout_view_overlay;
            ...
            LinearLayout linLayout_like_and_comment = itemView.findViewById(R.id.linLayout_like_and_comment);
        ...
        public void bindView(String url, int position) {
            ...
            Query query = myRef.child(context.getString(R.string.dbname_group))
            ...
            linLayout_comment.setOnClickListener(view -> {
                ...
                Intent intent = new Intent(context, GroupChildRecyclerComment.class);
        ...
        private final class GestureListenerLike extends GestureDetector.SimpleOnGestureListener {
            ...
            public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
                ...
                context.getWindow().setExitTransition(new Slide(Gravity.END));
                context.getWindow().setEnterTransition(new Slide(Gravity.START));
                Intent intent = new Intent(context, GroupRecyclerFullImage.class);
                Gson gson = new Gson();
                String myGson = gson.toJson(battleModel);
