...
public class GroupViewHolderRecyclerChildFirstCommentHeader extends RecyclerView.ViewHolder {
    private static final String TAG = "GroupViewHolderRecyclerChildFirstCommentHeader";
    ...
    public GroupViewHolderRecyclerChildFirstCommentHeader(AppCompatActivity context, BattleModel model, Comment commentModel,
