package com.bekambimouen.miiokychallenge.groups.comment.adapter.img_and_vid_double.bottomsheet_adapter;
...
public class GroupCommentImageDoubleBottomSheetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GroupCommentImageDoubleBottomSheetAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
