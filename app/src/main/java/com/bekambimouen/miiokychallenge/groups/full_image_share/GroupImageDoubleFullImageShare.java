...
public class GroupImageDoubleFullImageShare extends AppCompatActivity {
    private static final String TAG = "GroupImageDoubleFullImageShare";
    ...
    // vars
    private GroupImageDoubleFullImageShare context;
    ...
    // single bottom
    private String image_double_single_bottom;
    // top bottom
    private String image_double_top_bottom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_image_double_full_image_share);
        context = this;
        getBlackTheme();
    ...
    private void fullImage(int position) {
            ...
            if (from_comment != null) {
                ...
                if (image_double_top_bottom != null) {
                    ...
                    if (image_double_single_bottom != null) {
                        ...
                        // to show image une publication
                        intent.putExtra("image_double_single_bottom", "image_double_single_bottom");
                    }
        ...
        linLayout_share.setOnClickListener(view -> {
            ...
            try {
                ...
                bundle.putBoolean("group_image_double", true);
