...
public class InviteMembersSuggestionAdapter extends RecyclerView.Adapter<InviteMembersSuggestionAdapter.ViewHolder>
    ...
    private final String newGroupKey; // newGroupKey is the group_id when user is created group for the first time
    ...
    public InviteMembersSuggestionAdapter(AppCompatActivity context, List<User> userList, String newGroupKey, String theme,
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // group is not yet created because of the firebase latence
        if (user_groups == null) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(User user) {
            ...
            button_invite.setOnClickListener(view1 -> {
                ...
                HashMap<Object, Object> map_notification;
                // group is already created
                assert new_key != null;
                if (user_groups != null) {
                    map_notification = Utils_Map_Notification.setNotification(
                ...
                } // the group created for the first time
                else {
                    map_notification = Utils_Map_Notification.setNotification(
                            false, false, false, false, false,
                            false, false, false, false,
                            ...
                            false, false,
                            true,false, false,
                            user.getUser_id(), new_key, user_id, user_id,
                            "", newGroupKey, date.getTime(),
                            false, false,
                            false, false, false, false, false, false, false, false,
                            false, "", "", "", false, "", "", "", false,
                            "", "", "", "", "", 0,
