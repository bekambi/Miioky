...
import com.bekambimouen.miiokychallenge.groups.discover.adapter.GroupPublicViewProfileDiscoverAdapter;
...
public class GroupPublicViewProfileDiscover extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    private static final String TAG = "GroupPublicViewProfileDiscover";
    ...
    // vars
    private GroupPublicViewProfileDiscover context;
    private GroupPublicViewProfileDiscoverAdapter adapter;
    private UserGroups user_groups;
    private ArrayList<BattleModel> list;
    private Handler handler;
    private RelativeLayout relLayout_board;
    private RelativeLayout relLayout_challenges;
    private LinearLayout linLayout_challenges;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_public_view_profile_discover);
        context = this;
    ...
    private void init() {
        ...
        RelativeLayout relLayout_publisher = findViewById(R.id.relLayout_publisher);
        RelativeLayout relLayout_thought = findViewById(R.id.relLayout_thought);
        linLayout_challenges = findViewById(R.id.linLayout_challenges);
        LinearLayout linLayout_publisher = findViewById(R.id.linLayout_publisher);
        LinearLayout linLayout_thought = findViewById(R.id.linLayout_thought);
    ...
    private void displayPhotos() {
        if (list != null) {
            try {
                ...
                adapter = new GroupPublicViewProfileDiscoverAdapter(context, user_groups, progressBar, relLayout_view_overlay);
