...
import com.bekambimouen.miiokychallenge.groups.see_member_profile.adapter.SeeGroupMemberAllBackgroundProfileAdapter;
...
public class SeeGroupMemberAllBackgroundProfile extends AppCompatActivity {
    private static final String TAG = "SeeGroupMemberAllBackgroundProfile";
    ...
    // vars
    private SeeGroupMemberAllBackgroundProfile context;
    private SeeGroupMemberAllBackgroundProfileAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_see_group_member_all_background_profile);
        context = this;
        getBlackTheme();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    if (model.isGroup_cover_background_profile_photo())
                        list.add(model);
                }
                ...
                adapter = new SeeGroupMemberAllBackgroundProfileAdapter(context, list, relLayout_view_overlay);
