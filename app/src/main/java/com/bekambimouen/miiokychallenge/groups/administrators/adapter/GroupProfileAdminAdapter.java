...
public class GroupProfileAdminAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "GroupProfileAdminAdapter";
    // load more item
    ...
    public GroupProfileAdminAdapter(AppCompatActivity context, List<BattleModel> list,
                                    String userID, UserGroups user_groups, OnLoadMoreItemsListener mOnLoadMoreItemsListener,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == HEADER) {
            view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.layout_group_header_group_admin_profile, parent, false);
    ...
    public class RecyclerViewHeader extends RecyclerView.ViewHolder {
        ...
        private final CircleImageView user_profile_photo, admin_master_profile_photo;
        private final TextView date_following, total_members, username,
                admin_master_username, number_of_followers_and_friend, bio, txt_points;
        private final RelativeLayout relLayout_update, relLayout_see_the_profile;
        private final LinearLayout linLayout_about_me, linLayout_points;
        private final TextView no_yet_publication;

        // admins profile photo
        private final CircleImageView member_i, member_ii, member_iii, member_iv, member_v, member_vi, member_vii,
                member_viii, member_ix;
        private final RelativeLayout relLayout_profile_members, relLayout_member_i, relLayout_member_ii,
        ...
        private int t = 0, nber_of_followers = 0, nber_of_friends = 0;
        ...
        public RecyclerViewHeader(RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
            ...
            admin_master_profile_photo = itemView.findViewById(R.id.admin_master_profile_photo);
            admin_master_username = itemView.findViewById(R.id.admin_master_username);
            ...
            relLayout_profile_members = itemView.findViewById(R.id.relLayout_profile_members);
            relLayout_member_i = itemView.findViewById(R.id.relLayout_member_i);
            ...
            query1.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot ds: snapshot.getChildren()) {
                        ...
                        no_yet_publication.setText(Html.fromHtml(userName+" "+context.getString(R.string.no_yet_publication)+
                                " <b>"+user_groups.getGroup_name()+"</b>"));

                        // profile photo and username on Miioky
                        ...
                        relLayout_see_the_profile.setOnClickListener(v -> {
                            ...
                            context.getWindow().setEnterTransition(new Slide(Gravity.START));
                            Intent intent;
                            if (user.getUser_id().equals(Objects.requireNonNull(Objects.requireNonNull(FirebaseAuth.getInstance().getCurrentUser())).getUid())) {
            ...
            myQuery1.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot dataSnapshot: snapshot.getChildren()) {
                        ...
                        // get admins and moderators list
                        if (follower.isAdminInGroup() || follower.isModerator())
                            membersList.add(follower.getUser_id());
                    }

                    total_members.setText(Html.fromHtml("<b>"+ (t+1)+"</b> "+context.getString(R.string.total_members)));
