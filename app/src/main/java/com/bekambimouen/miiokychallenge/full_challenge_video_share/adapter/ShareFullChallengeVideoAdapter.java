package com.bekambimouen.miiokychallenge.full_challenge_video_share.adapter;
...
public class ShareFullChallengeVideoAdapter extends RecyclerView.Adapter<ShareFullChallengeVideoAdapter.MyViewHolder> {
    ...
    public ShareFullChallengeVideoAdapter(AppCompatActivity context, List<ChallengeModel> list,
