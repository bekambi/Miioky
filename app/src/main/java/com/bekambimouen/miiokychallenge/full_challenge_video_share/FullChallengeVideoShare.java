package com.bekambimouen.miiokychallenge.full_challenge_video_share;
...
import com.bekambimouen.miiokychallenge.full_challenge_video_share.adapter.ShareFullChallengeVideoAdapter;
...
public class FullChallengeVideoShare extends AppCompatActivity {
    private static final String TAG = "ShareFullChallengeVideo";
    ...
    // vars
    private FullChallengeVideoShare context;
    private ShareFullChallengeVideoAdapter adapter;
    ...
    // single top
    private String video_double_single_top;
    private String response_vid_double_single_top;

    // single top bottom on miioky
    private String video_double_single_top_bottom;
    private String response_vid_double_on_miioky;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_challenge_video_share);
        context = this;
        getBlackTheme();
        ...
        try {
            ...
            // single top bottom on miioky
            video_double_single_top_bottom = getIntent().getStringExtra("video_double_single_top_bottom");
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    ShareFullChallengeVideoAdapter adapter = new ShareFullChallengeVideoAdapter(context,
                ...
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            adapter = new ShareFullChallengeVideoAdapter(context,
                                    challengeList, playerViewListener, progressBar);
                            recyclerView.setAdapter(adapter);
    ...
    private void getData(int position) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    if (challengeGson != null) {
                        ...
                        if (response_vid_double_on_miioky != null) {
                            relLayout_go_user_profile.setOnClickListener(v -> {
                                Log.d(TAG, "onClick: navigating to profile of: " +
                                        user.getUsername());
        ...
        ivEnveloppe.setOnClickListener(view -> {
            ...
            if (from_comment != null) {
                ...
                Gson gson = new Gson();
                String myGSon = gson.toJson(battleModel);
                if (video_double_single_top != null) {
                    intent.putExtra("comment_image_double_single_top", myGSon);
                    // to show image une publication
                    intent.putExtra("video_double_single_top", "video_double_single_top");

                }  else if (response_vid_double_single_top != null) {
                    intent.putExtra("comment_reponse_image_double_single_top", myGSon);
                    // to show image une publication
                    intent.putExtra("response_vid_double_single_top", "response_vid_double_single_top");

                } else
                    // top bottom
                    if (video_double_single_top_bottom != null) {
                        intent.putExtra("comment_image_double_on_miioky", myGSon);
                        // to show image une publication
                        intent.putExtra("video_double_on_miioky", "video_double_on_miioky");
                    }  else if (response_vid_double_on_miioky != null) {
                        intent.putExtra("comment_reponse_image_double_on_miioky", myGSon);
                        // to show image une publication
                        intent.putExtra("response_vid_double_on_miioky", "response_vid_double_on_miioky");
