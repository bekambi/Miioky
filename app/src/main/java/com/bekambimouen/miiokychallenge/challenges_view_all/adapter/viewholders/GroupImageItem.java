...
public class GroupImageItem extends RecyclerView.ViewHolder {
    ...
    public GroupImageItem(AppCompatActivity context, String user_id, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
