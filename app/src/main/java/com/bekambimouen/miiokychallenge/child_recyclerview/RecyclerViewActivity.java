package com.bekambimouen.miiokychallenge.child_recyclerview;
...
public class RecyclerViewActivity extends AppCompatActivity {
    ...
    private void getData() {
        if (battleModel != null) {
            ...
            RecyclerViewAdapter adapter = new RecyclerViewAdapter(context, listUrl, battleModel, progressBar, relLayout_view_overlay);
