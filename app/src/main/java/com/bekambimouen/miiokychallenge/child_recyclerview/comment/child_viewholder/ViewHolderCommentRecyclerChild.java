package com.bekambimouen.miiokychallenge.child_recyclerview.comment.child_viewholder;
...
public class ViewHolderCommentRecyclerChild extends RecyclerView.ViewHolder {
    private static final String TAG = "ViewHolderCommentRecycler";
    ...
    // for notification
    private final String post_id_field, category_of_post, post_type, post_id, admin_master, the_user_who_posted_id, group_id;
    private final String recyclerview_photo_id, recyclerview_fieldLike;

    // firebase
    private final DatabaseReference myRef;

    public ViewHolderCommentRecyclerChild(AppCompatActivity context, BattleModel battleModel, String recyclerview_photo_id,
                                          String recyclerview_fieldLike, ItemImageUneClickListener itemImageUneClickListener,
                                          ...
                                          String group_id, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for ( DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    commentaire.setCharText(comment.getComment());
                    ...
                    comment_reply.setOnClickListener(view -> itemImageUneClickListener.onClick(comment.getCommentKey(),
                            ...
                            comment, recyclerview_photo_id, recyclerview_fieldLike, comment.getDate_created()));
                    ...
                    see_comments.setOnClickListener(view -> {
                        ...
                        context.getWindow().setExitTransition(new Slide(Gravity.END));
                        context.getWindow().setEnterTransition(new Slide(Gravity.START));
                        Intent intent = new Intent(context, ChildRecyclerResponseComment.class);
                        Gson gson = new Gson();
                        ...
                        intent.putExtra("recyclerview_photo_id_upload", recyclerview_photo_id);
                        intent.putExtra("recyclerview_fieldLike_upload", recyclerview_fieldLike);
    ...
    public void addNewLike(Comment comment){
    ...
    private void getCurrentUser(Comment comment){
        Query query = myRef
                .child(context.getString(R.string.dbname_users))
                .orderByChild(context.getString(R.string.field_user_id))
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for ( DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    String username = user.getUsername();
                    comment_username_first_comment.setText(username);
