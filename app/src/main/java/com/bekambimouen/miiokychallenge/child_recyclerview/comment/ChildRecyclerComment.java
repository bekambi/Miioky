...
import com.bekambimouen.miiokychallenge.child_recyclerview.comment.child_viewholder.adapter.CommentRecyclerChildAdapter;
...
public class ChildRecyclerComment extends AppCompatActivity {
    private static final String TAG = "ChildRecyclerComment";
    ...
    // vars
    private ChildRecyclerComment context;
    private BattleModel battleModel, comment_recycler_child;
    private CommentRecyclerChildAdapter recycler_child_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_child_recycler_comment);
        context = this;
    ...
    private void setupWidgets(BattleModel battleModel){
        ...
        recycler_child_adapter = new CommentRecyclerChildAdapter(this, commentsList,
