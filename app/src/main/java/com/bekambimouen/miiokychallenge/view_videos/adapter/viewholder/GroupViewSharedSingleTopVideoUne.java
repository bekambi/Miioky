...
public class GroupViewSharedSingleTopVideoUne extends RecyclerView.ViewHolder implements ToroPlayer, ToroPlayer.EventListener,
        Player.Listener, CacheListener {
    private static final String TAG = "GroupViewHolderSingleTopVideoUne";
    ...
    public GroupViewSharedSingleTopVideoUne(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    public void bindVideo(BattleModel model) {
        ...
        if (video.getSharing_admin_master().equals(user_id))
        ...
        linLayout_comment.setOnClickListener(view -> {
            ...
            intent.putExtra("video_une_single_top", "video_une_single_top");
    ...
    // follow user _________________________________________________________________________________
