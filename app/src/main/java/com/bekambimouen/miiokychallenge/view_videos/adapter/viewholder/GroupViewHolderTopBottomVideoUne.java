...
public class GroupViewHolderTopBottomVideoUne extends RecyclerView.ViewHolder implements ToroPlayer, ToroPlayer.EventListener,
        Player.Listener, CacheListener {
    private static final String TAG = "GroupViewHolderTopBottomVideoUne";
    ...
    public GroupViewHolderTopBottomVideoUne(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    public void bindVideo(BattleModel model) {
        ...
        if (video.getAdmin_master().equals(user_id))
            sharing_join_group.setVisibility(View.GONE);
        ...
        linLayout_comment.setOnClickListener(view -> {
            ...
            intent.putExtra("video_une_top_bottom", "video_une_top_bottom");
