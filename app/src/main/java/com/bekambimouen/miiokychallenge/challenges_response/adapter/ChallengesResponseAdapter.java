package com.bekambimouen.miiokychallenge.challenges_response.adapter;
...
public class ChallengesResponseAdapter extends PaginatedAdapter<BattleModel, RecyclerView.ViewHolder> {
    private static final String TAG = "ChallengesResponseAdapter";
    ...
    public ChallengesResponseAdapter(AppCompatActivity context, ProgressBar progressBar, RelativeLayout relLayout_view_overlay) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (itemViewType == REPONSE_IMG_DOUBLE) {
            ...
            BottomSheetAnswerChallenge bottomSheet = new BottomSheetAnswerChallenge(context, model, "video", model.getInvite_url(),
