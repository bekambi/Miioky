...
public class ImageUneFullImageShare extends AppCompatActivity {
    private static final String TAG = "ImageUneFullImageShare";
    // widgets
    ...
    // vars
    private ImageUneFullImageShare context;
    ...
    // single top
    private String image_une_single_top;
    // single top bottom
    private String image_une_on_miioky;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_une_full_image_share);
        context = this;
        getBlackTheme();
