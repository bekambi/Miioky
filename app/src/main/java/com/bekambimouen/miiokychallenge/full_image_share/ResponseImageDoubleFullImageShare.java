...
public class ResponseImageDoubleFullImageShare extends AppCompatActivity {
    private static final String TAG = "ResponseImageDoubleFullImageShare";
    ...
    // vars
    private ResponseImageDoubleFullImageShare context;
    private BattleModel model;
    private BottomSheetSharePublication bottomSheetShare;
    private List<String> user_id_list, url_list, photo_id_list, caption_list, id_list;
    private String from_comment;
    private int position;
    private int comments_count, shares_count;
    // single top
    private String response_img_double_single_top;
    // single top bottom
    private String response_img_double_on_miioky;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_response_image_double_full_image_share);
        context = this;
        getBlackTheme();
        ...
        if (model != null) {
            ...
            user_id_list.add(model.getReponse_user_id());
            user_id_list.add(model.getInvite_userID());
    ...
    private void fullImage(int position) {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                for (DataSnapshot ds: snapshot.getChildren()) {
                                    ...
                                    relLayout_username.setOnClickListener(v -> {
                                        ...
                                        intent.putExtra("userID", user_id_list.get(position));
        ...
        linLayout_comment.setOnClickListener(view -> {
            ...
            if (from_comment != null) {
                ...
                if (response_img_double_single_top != null) {
                    ...
                    intent.putExtra("response_img_double_single_top", "response_img_double_single_top");
                } else if (response_img_double_on_miioky != null) {
        ...
        linLayout_share.setOnClickListener(view -> {
            ...
            try {
                ...
                bundle.putBoolean("reponseImageDouble_shared", true);
