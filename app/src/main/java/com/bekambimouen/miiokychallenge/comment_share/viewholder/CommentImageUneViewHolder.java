...
public class CommentImageUneViewHolder extends RecyclerView.ViewHolder {
    ...
    public CommentImageUneViewHolder(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for ( DataSnapshot ds :  dataSnapshot.getChildren()){
                    ...
                    Glide.with(((Activity) context))
                            .load(Objects.requireNonNull(ds.getValue(User.class)).getProfileUrl())
                            .placeholder(R.drawable.ic_baseline_person_24)
