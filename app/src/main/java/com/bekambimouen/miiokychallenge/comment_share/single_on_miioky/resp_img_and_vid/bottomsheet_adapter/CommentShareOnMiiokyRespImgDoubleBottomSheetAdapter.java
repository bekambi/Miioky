...
public class CommentShareOnMiiokyRespImgDoubleBottomSheetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentShareOnMiiokyRespImgDoubleBottomSheetAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
