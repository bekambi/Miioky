...
import com.bekambimouen.miiokychallenge.comment_share.comment_response.ViewHolderShareResponse_response_image_double;
...
public class CommentShareResponseResponseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "CommentShareResponseResponseAdapter";
    ...
    public CommentShareResponseResponseAdapter(AppCompatActivity context, ArrayList<CommentResponse> list,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == FIRST_COMMENT) {
            ...
            return new ViewHolderShareResponse_response_image_double(context, model, comment_key, mChildItemClickListener, relLayout_view_overlay, view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderShareResponse_response_image_double response_image_double = (ViewHolderShareResponse_response_image_double) holder;
