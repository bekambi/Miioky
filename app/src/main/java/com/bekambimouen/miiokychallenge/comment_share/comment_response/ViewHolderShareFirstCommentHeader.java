...
public class ViewHolderShareFirstCommentHeader extends RecyclerView.ViewHolder {
    private static final String TAG = "ViewHolderShareFirstCommentHeader";
    ...
    public ViewHolderShareFirstCommentHeader(AppCompatActivity context, BattleModel model, BattleModel comment_recycler_child,
