...
public class CommentResponseImgDoubleViewHolder extends RecyclerView.ViewHolder {
    ...
    public CommentResponseImgDoubleViewHolder(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
