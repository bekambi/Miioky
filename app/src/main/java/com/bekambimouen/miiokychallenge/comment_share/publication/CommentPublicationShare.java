package com.bekambimouen.miiokychallenge.comment_share.publication;
...
public class CommentPublicationShare extends AppCompatActivity {
    private static final String TAG = "CommentPublicationShare";
    ...
    //vars
    private CommentPublicationShare context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comment_publication_share);
        context = this;
