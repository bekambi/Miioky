...
public class CommentShareSingleTopImageDoubleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentShareSingleTopImageDoubleAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_shared_single_top_imagedouble, parent, false);
            return new SharedSingleTopImageDoubleDisplay(context, battleModel, mComment, from_full_image, relLayout_view_overlay, view);
