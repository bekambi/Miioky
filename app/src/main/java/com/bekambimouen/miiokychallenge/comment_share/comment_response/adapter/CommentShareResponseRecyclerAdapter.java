...
import com.bekambimouen.miiokychallenge.comment_share.comment_response.ViewHolderShareResponseComment_recycler;
...
public class CommentShareResponseRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "CommentShareResponseRecyclerAdapter";
    ...
    public CommentShareResponseRecyclerAdapter(AppCompatActivity context, ArrayList<CommentResponse> list,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == FIRST_COMMENT) {
            ...
            return new ViewHolderShareResponseComment_recycler(context, model, comment_key, mChildItemClickListener, relLayout_view_overlay, view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderShareResponseComment_recycler responseComment = (ViewHolderShareResponseComment_recycler) holder;
