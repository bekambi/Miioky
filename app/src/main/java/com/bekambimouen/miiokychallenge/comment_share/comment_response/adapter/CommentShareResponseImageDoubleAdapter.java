...
import com.bekambimouen.miiokychallenge.comment_share.comment_response.ViewHolderShareResponse_image_double;
...
public class CommentShareResponseImageDoubleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final String TAG = "CommentShareResponseImageDoubleAdapter";
    ...
    public CommentShareResponseImageDoubleAdapter(AppCompatActivity context, ArrayList<CommentResponse> list,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == FIRST_COMMENT) {
            ...
            return new ViewHolderShareResponse_image_double(context, model, comment_key, mChildItemClickListener, relLayout_view_overlay, view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            ViewHolderShareResponse_image_double image_double = (ViewHolderShareResponse_image_double) holder;
