...
public class CommentShareOnMiiokyImageDoubleBottomSheetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentShareOnMiiokyImageDoubleBottomSheetAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
