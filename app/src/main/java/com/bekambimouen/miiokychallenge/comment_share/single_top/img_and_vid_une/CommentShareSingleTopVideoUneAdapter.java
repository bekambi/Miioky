package com.bekambimouen.miiokychallenge.comment_share.single_top.img_and_vid_une;
...
import com.bekambimouen.miiokychallenge.comment_share.viewholder.CommentImageUneViewHolder;
...
public class CommentShareSingleTopVideoUneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentShareSingleTopVideoUneAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_shared_single_top_videoune, parent, false);
            return new SharedSingleTopVideoUneDisplay(context, battleModel, mComment, from_full_video, relLayout_view_overlay, view);

        } else {
            view = inflater.inflate(R.layout.layout_comment, parent, false);
            return new CommentImageUneViewHolder(context, battleModel, itemImageUneClickListener,
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (view_type == COMMENT) {
            CommentImageUneViewHolder commentImageUne = (CommentImageUneViewHolder) holder;
