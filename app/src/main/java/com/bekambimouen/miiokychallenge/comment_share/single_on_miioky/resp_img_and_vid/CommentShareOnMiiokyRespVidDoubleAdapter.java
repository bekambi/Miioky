package com.bekambimouen.miiokychallenge.comment_share.single_on_miioky.resp_img_and_vid;
...
public class CommentShareOnMiiokyRespVidDoubleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentShareOnMiiokyRespVidDoubleAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_main_shared_reponse_videodouble, parent, false);
            return new SharedResponseVideoDoubleDisplay(context, battleModel, mComment, from_full_video, relLayout_view_overlay, view);
