...
public class CommentShareRecyclerViewHolder extends RecyclerView.ViewHolder {
    ...
    public CommentShareRecyclerViewHolder(AppCompatActivity context, BattleModel battleModel, ItemImageUneClickListener itemImageUneClickListener,
