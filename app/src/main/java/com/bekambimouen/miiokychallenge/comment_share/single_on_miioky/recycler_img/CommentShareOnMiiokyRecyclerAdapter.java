package com.bekambimouen.miiokychallenge.comment_share.single_on_miioky.recycler_img;
...
public class CommentShareOnMiiokyRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentShareOnMiiokyRecyclerAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == PHOTO_HEADER) {
            view = inflater.inflate(R.layout.layout_main_shared_recycler, parent, false);
            return new SharedRecyclerItemDisplay(context, battleModel, mComment, from_view_recyclerview, relLayout_view_overlay, view);
