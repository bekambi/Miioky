package com.bekambimouen.miiokychallenge.comment_share.single_on_miioky.resp_img_and_vid.bottomsheet_adapter;
...
public class CommentShareOnMiiokyRespVidDoubleBottomSheetAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommentShareOnMiiokyRespVidDoubleBottomSheetAdapter(AppCompatActivity context, ArrayList<Comment> list, BattleModel battleModel,
