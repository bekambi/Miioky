...
import com.bekambimouen.miiokychallenge.full_image.bottomSheet_add_recycler_description.BottomSheetAddRecyclerImageDescription;
...
public class RecyclerFullImage extends AppCompatActivity {
    private static final String TAG = "RecyclerFullImage";
    ...
    private BottomSheetAddRecyclerImageDescription bottomSheetAddRecyclerImageDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_full_image);
        context = this;
        getBlackTheme();
    ...
    private void fullImage(int position) {
        ...
        if (model.getUser_id().equals(user_id)) {
            ...
            bottomSheetAddRecyclerImageDescription =
                    new BottomSheetAddRecyclerImageDescription(context, model,
        ...
        linLayout_comment.setOnClickListener(view -> {
            ...
            if (from_comment != null) {
                ...
                intent.putExtra("from_view_recyclerview", "from_view_recyclerview");
                context.startActivity(intent);
            }
        });
        ...
        bottomSheetShare = new BottomSheetSharePublication(context, null, model.getUser_id(), url_list.get(position),
                photo_id_list.get(position), "from_recyclerView_item", "", false);
