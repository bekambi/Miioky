...
public class ResponseImageDoubleFullImage extends AppCompatActivity {
    private static final String TAG = "ResponseImageDoubleFullImage";
    ...
    // vars
    private ResponseImageDoubleFullImage context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_response_image_double_full_image);
        context = this;
        getBlackTheme();
    ...
    private void fullImage(int position) {
        ...
        linLayout_share.setOnClickListener(view -> {
            ...
            try {
                ...
                bundle.putBoolean("response_image_double", true);
