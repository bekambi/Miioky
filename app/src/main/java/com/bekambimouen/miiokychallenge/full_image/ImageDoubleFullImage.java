...
public class ImageDoubleFullImage extends AppCompatActivity {
    private static final String TAG = "ImageDoubleFullImage";
    ...
    // vars
    private ImageDoubleFullImage context;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_double_full_image);
        context = this;
        getBlackTheme();
    ...
    private void fullImage(int position) {
        ...
        linLayout_share.setOnClickListener(view -> {
            ...
            try {
                ...
                bundle.putBoolean("image_double", true);
