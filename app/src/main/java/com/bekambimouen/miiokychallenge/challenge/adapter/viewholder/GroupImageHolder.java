...
public class GroupImageHolder extends RecyclerView.ViewHolder {
    ...
    private final ArrayList<String> invite_photo_id_List, group_id_List;
    ...
    public GroupImageHolder(AppCompatActivity context, RelativeLayout relLayout_view_overlay, @NonNull View itemView) {
        super(itemView);
    ...
    private final class GestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(@NonNull MotionEvent e) {
            ...
            Intent intent = new Intent(context, SimpleFullImage.class);
            Gson gson = new Gson();
    ...
    public void bindView(ModelInvite model) {
        ...
        bottomSheetShare = new BottomSheetSharePublication(context, null, model.getInvite_userID(), model.getInvite_url(),
                model.getInvite_photoID(), "from_full_image", "", false);
        ...
        myQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    k++;
                    group_id_List.add(challengeModel.getId());
                ...
                relLayout_answered_challenge.setOnClickListener(view -> {
                    ...
                    intent.putExtra("id_List", group_id_List);
