...
public class AddEstablishmentAdapter extends RecyclerView.Adapter<AddEstablishmentAdapter.MyViewHolder> {
    ...
    public AddEstablishmentAdapter(AppCompatActivity context, ArrayList<FrequentedEstablishment> list, RelativeLayout relLayout_view_overlay) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_establishment_item, parent, false);
                    ...
                    positiveButton.setOnClickListener(view1 -> {
                        ...
                        new Thread(() -> {
                            ...
                            FirebaseDatabase.getInstance().getReference().child(context.getString(R.string.dbname_users))
                                    ...
                                    .child(establishment.getEstablishmentKey())
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(FrequentedEstablishment establishment) {
            ...
            itemView.setOnClickListener(view -> {
                ...
                intent.putExtra("update_establishment_name", "update_establishment_name");
                intent.putExtra("establishmentKey", establishment.getEstablishmentKey());
                intent.putExtra("establishment_name", establishment.getUser_establishment());
                intent.putExtra("establishment_name_header", establishment.getUser_establishment_header());
