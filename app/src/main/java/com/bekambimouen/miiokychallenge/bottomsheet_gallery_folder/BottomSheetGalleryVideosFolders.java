...
import com.bekambimouen.miiokychallenge.publication_insta.adapter.FolderVideosAdapter;
...
public class BottomSheetGalleryVideosFolders extends BottomSheetDialogFragment {
    ...
    private FolderVideosAdapter folderVideosAdapter;
    ...
    public BottomSheetGalleryVideosFolders(AppCompatActivity context, VideoListAdapter videoAdapter
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        new Handler().postDelayed(() -> {
            ...
            folderVideosAdapter = new FolderVideosAdapter(context, folderList, videoAdapter, videosList, dialog, toolBar_textview,
                    progressBar);
