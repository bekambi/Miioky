...
import com.bekambimouen.miiokychallenge.challenge.adapter.FolderResponseChallengeImagesAdapter;
...
public class BottomSheetGalleryResponseChallengePhotosFolders extends BottomSheetDialogFragment {
    ...
    private FolderResponseChallengeImagesAdapter folderImagesAdapter;
    ...
    public BottomSheetGalleryResponseChallengePhotosFolders(AppCompatActivity context, StoryGridImageAdapter imageAdapter
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        new Handler().postDelayed(() -> {
            ...
            folderImagesAdapter = new FolderResponseChallengeImagesAdapter(context, folderList, imageAdapter, imageList, dialog, toolBar_textview,
                    progressBar);
