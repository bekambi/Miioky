...
import com.bekambimouen.miiokychallenge.publication_insta.adapter.FolderImagesAdapter;
...
public class BottomSheetGalleryPhotosFolders extends BottomSheetDialogFragment {
    ...
    public BottomSheetGalleryPhotosFolders(AppCompatActivity context, ImageAdapter imageAdapter
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        new Handler().postDelayed(() -> {
            ...
            folderImagesAdapter = new FolderImagesAdapter(context, folderList, imageAdapter, imageList, dialog, toolBar_textview,
                    progressBar);
