...
import com.bekambimouen.miiokychallenge.groups.publication.adapter.FolderGroupVideosAdapter;
...
public class BottomSheetGroupGalleryVideosFolders extends BottomSheetDialogFragment {
    ...
    private FolderGroupVideosAdapter folderVideosAdapter;
    ...
    private final GroupVideoListAdapter videoAdapter;
    private final ArrayList<VideoItem> videosList;
    private final TextView toolBar_textview;

    public BottomSheetGroupGalleryVideosFolders(AppCompatActivity context, GroupVideoListAdapter videoAdapter
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        new Handler().postDelayed(() -> {
            ...
            folderVideosAdapter = new FolderGroupVideosAdapter(context, folderList, videoAdapter, videosList, dialog, toolBar_textview,
                    progressBar);
