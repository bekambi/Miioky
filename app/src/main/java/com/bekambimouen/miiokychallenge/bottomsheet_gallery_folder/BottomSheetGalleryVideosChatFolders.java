...
import com.bekambimouen.miiokychallenge.messages.adapter.FolderVideosChatAdapter;
...
public class BottomSheetGalleryVideosChatFolders extends BottomSheetDialogFragment {
    ...
    private FolderVideosChatAdapter folderVideosAdapter;
    ...
    private final VideoChatListAdapter videoAdapter;
    private final ArrayList<VideoItem> videosList;
    private final TextView toolBar_textview;

    public BottomSheetGalleryVideosChatFolders(AppCompatActivity context, VideoChatListAdapter videoAdapter
    ...
    public void setupDialog(@NonNull Dialog dialog, int style) {
        ...
        new Handler().postDelayed(() -> {
            ...
            folderVideosAdapter = new FolderVideosChatAdapter(context, folderList, videoAdapter, videosList, dialog, toolBar_textview,
                    progressBar);
