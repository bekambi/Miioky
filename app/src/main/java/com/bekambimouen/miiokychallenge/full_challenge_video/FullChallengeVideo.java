package com.bekambimouen.miiokychallenge.full_challenge_video;
...
import com.bekambimouen.miiokychallenge.full_challenge_video.adapter.FullChallengeVideoAdapter;
...
public class FullChallengeVideo extends AppCompatActivity {
    private static final String TAG = "FullChallengeVideo";
    ...
    private RelativeLayout relLayout_go_user_profile;
    ...
    // vars
    private FullChallengeVideo context;
    private FullChallengeVideoAdapter adapter;
    ...
    private String from_video_double, from_response_video_double, from_comment, photo_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_challenge_video);
        context = this;
        getBlackTheme();
        ...
        try {
            ...
            from_video_double = getIntent().getStringExtra("from_video_double");
            from_response_video_double = getIntent().getStringExtra("from_response_video_double");
        ...
        if (challengeGson != null) {
            ...
            photo_id = challengeGson.getPhoto_id_un();
            ...
            photo_id = challengeRepGson.getReponse_photoID();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    FullChallengeVideoAdapter adapter = new FullChallengeVideoAdapter(context,
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()) {
                    ...
                    String reponse_userID = user_reponse.getUser_id();
                    String reponse_profil = user_reponse.getProfileUrl();
                    String reponse_name = user_reponse.getUsername();
                    ...
                    challengeList.add(new ChallengeModel(reponse_profil, challengeRepGson.getReponse_url(), challengeRepGson.getThumbnail_response(),
                            ...
                            reponse_userID, user_reponse, challengeRepGson.getDate_created(), challengeRepGson.getReponse_country_name(),
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            for (DataSnapshot ds: snapshot.getChildren()) {
                                ...
                                String invite_userID = user_invite.getUser_id();
                                String invite_profil = user_invite.getProfileUrl();
                                String invite_name = user_invite.getUsername();
                                ...
                                challengeList.add(new ChallengeModel(invite_profil, challengeRepGson.getInvite_url(), challengeRepGson.getThumbnail_invite(),
                                        ...
                                        invite_userID, user_invite, challengeRepGson.getDate_created(),
                                        challengeRepGson.getInvite_country_name(), challengeRepGson.getInvite_countryID()));
                            }

                            adapter = new FullChallengeVideoAdapter(context,
                                    challengeList, playerViewListener, progressBar);
                            recyclerView.setAdapter(adapter);
    ...
    private void getData(int position) {
        ...
        if (challengeGson != null) {
            myQuery = myRef
                    ...
                    .equalTo(battleModel.getUser_id());
        ...
        // share
        bottomSheetShare = new BottomSheetSharePublication(context, null, battleModel.getUser_id(),
                challengeList.get(position).getUrl(), "", photo_id_list.get(position),
                "from_video", false);
        share.setOnClickListener(view -> {
            ...
            try {
                ...
                bundle.putBoolean("response_video_double", true);
