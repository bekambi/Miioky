...
public final class ActivityCrushersBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCrushersBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout arrowBack, @NonNull MyEditText editSearch, @NonNull ImageView erase,
      @NonNull RelativeLayout parent, @NonNull TextView people, @NonNull ProgressBar progressBar,
  ...
  @NonNull
  public static ActivityCrushersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCrushersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_crushers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCrushersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCrushersBinding((RelativeLayout) rootView, arrowBack, editSearch, erase,
          parent, people, progressBar, recyclerView, relLayoutSearch, relLayoutViewOverlay,
