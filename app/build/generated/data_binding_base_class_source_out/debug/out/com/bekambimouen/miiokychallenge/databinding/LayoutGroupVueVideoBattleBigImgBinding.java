...
public final class LayoutGroupVueVideoBattleBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupVueVideoBattleBigImgBinding(@NonNull LinearLayout rootView,
      @NonNull TextView admin, @NonNull TextView button, @NonNull ViewMoreTextView caption,
      @NonNull CardView cardView, @NonNull TextView category, @NonNull TextView countryName,
      @NonNull TextView downloadedCount, @NonNull ImageView flagIcon, @NonNull TextView groupName,
      @NonNull ImageView groupProfilePhoto, @NonNull ImageView imgPlay, @NonNull ImageView ivShare,
      @NonNull TextView joinGroup, @NonNull LinearLayout linLayoutFlag,
      ...
      @NonNull RelativeLayout relLayout1, @NonNull RelativeLayout relLayoutAdmin,
  ...
  @NonNull
  public static LayoutGroupVueVideoBattleBigImgBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGroupVueVideoBattleBigImgBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_group_vue_video_battle_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupVueVideoBattleBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupVueVideoBattleBigImgBinding((LinearLayout) rootView, admin, button,
          caption, cardView, category, countryName, downloadedCount, flagIcon, groupName,
          groupProfilePhoto, imgPlay, ivShare, joinGroup, linLayoutFlag, linLayoutShare, menuItem,
          point, point1, profilePhoto, relLayout1, relLayoutAdmin, relLayoutCategory,
