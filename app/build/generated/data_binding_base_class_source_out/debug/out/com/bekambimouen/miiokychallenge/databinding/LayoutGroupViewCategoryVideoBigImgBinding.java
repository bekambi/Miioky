...
public final class LayoutGroupViewCategoryVideoBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupViewCategoryVideoBigImgBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutGroupViewCategoryVideoBigImgBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static LayoutGroupViewCategoryVideoBigImgBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.layout_group_view_category_video_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupViewCategoryVideoBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupViewCategoryVideoBigImgBinding((LinearLayout) rootView, caption,
          cardView, category, countryName, downloadedCount, flagIcon, groupName, groupProfilePhoto,
          imgPlay, ivShare, joinGroup, linLayoutFlag, linLayoutShare, menuItem, point, point2,
          profilePhoto, relLayout1, relLayoutCategory, relLayoutCountActions, relLayoutDownload,
