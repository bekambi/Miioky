...
public final class LayoutVueUserVideoBattleItemBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutVueUserVideoBattleItemBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutVueUserVideoBattleItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutVueUserVideoBattleItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_vue_user_video_battle_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutVueUserVideoBattleItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutVueUserVideoBattleItemBinding((LinearLayout) rootView, button, caption,
