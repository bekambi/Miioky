...
public final class LayoutGroupVueUserVideoBattleBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupVueUserVideoBattleBigImgBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull ImageView imgPlay, @NonNull ImageView ivShare, @NonNull TextView joinGroup,
      ...
      @NonNull TextView shareCount, @NonNull ImageView thumbnail, @NonNull TextView tpsPublication,
  ...
  @NonNull
  public static LayoutGroupVueUserVideoBattleBigImgBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static LayoutGroupVueUserVideoBattleBigImgBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.layout_group_vue_user_video_battle_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupVueUserVideoBattleBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupVueUserVideoBattleBigImgBinding((LinearLayout) rootView, admin, button,
          caption, cardView, category, downloadedCount, groupName, groupProfilePhoto, icon, imgPlay,
          ivShare, joinGroup, linLayoutShare, menuItem, nberAcceptChallenge, point, point1,
          profilePhoto, relLayout1, relLayoutAdmin, relLayoutAnsweredChallenge, relLayoutCategory,
          relLayoutCountActions, relLayoutDownload, relLayoutGroupName, relLayoutProfile,
          relLayoutPublisher, relLayoutShare, relLayoutUsername, shareCount, thumbnail,
