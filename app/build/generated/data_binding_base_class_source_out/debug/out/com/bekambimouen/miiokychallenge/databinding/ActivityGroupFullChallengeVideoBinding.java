...
public final class ActivityGroupFullChallengeVideoBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupFullChallengeVideoBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupFullChallengeVideoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupFullChallengeVideoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_full_challenge_video, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupFullChallengeVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupFullChallengeVideoBinding((RelativeLayout) rootView, caption,
          category, container, countryName, denominateur, diviseur, flagIcon, imgVol, ivDownload,
          ivImage, ivShare, messageVideo, nbCommentaires, numerateur, optionCameraVideo, parent,
