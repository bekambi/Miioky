...
public final class LayoutVueImageBattleBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutVueImageBattleBigImgBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutVueImageBattleBigImgBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutVueImageBattleBigImgBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_vue_image_battle_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutVueImageBattleBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutVueImageBattleBigImgBinding((LinearLayout) rootView, button, caption,
