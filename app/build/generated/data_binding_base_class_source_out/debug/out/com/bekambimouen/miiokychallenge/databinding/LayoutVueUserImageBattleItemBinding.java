...
public final class LayoutVueUserImageBattleItemBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutVueUserImageBattleItemBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutVueUserImageBattleItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutVueUserImageBattleItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_vue_user_image_battle_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutVueUserImageBattleItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutVueUserImageBattleItemBinding((LinearLayout) rootView, button, caption,
