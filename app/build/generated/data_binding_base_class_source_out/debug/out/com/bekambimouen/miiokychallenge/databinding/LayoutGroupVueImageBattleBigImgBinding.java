...
public final class LayoutGroupVueImageBattleBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupVueImageBattleBigImgBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull ImageView groupProfilePhoto, @NonNull ImageView imageInvite,
  ...
  @NonNull
  public static LayoutGroupVueImageBattleBigImgBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGroupVueImageBattleBigImgBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_group_vue_image_battle_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupVueImageBattleBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupVueImageBattleBigImgBinding((LinearLayout) rootView, admin, button,
          caption, cardView, category, countryName, downloadedCount, flagIcon, groupName,
          groupProfilePhoto, imageInvite, ivShare, joinGroup, linLayoutFlag, linLayoutShare,
          menuItem, point, point1, profilePhoto, relLayout1, relLayoutAdmin, relLayoutCategory,
          relLayoutCountActions, relLayoutDownload, relLayoutGroupName, relLayoutProfile,
          relLayoutPublisher, relLayoutShare, relLayoutUsername, shareCount, tpsPublication,
          translateComment, username, viewOnline);
    }
