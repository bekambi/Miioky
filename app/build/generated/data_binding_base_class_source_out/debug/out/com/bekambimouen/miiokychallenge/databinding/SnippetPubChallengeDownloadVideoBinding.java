...
public final class SnippetPubChallengeDownloadVideoBinding implements ViewBinding {
  @NonNull
  ...
  private SnippetPubChallengeDownloadVideoBinding(@NonNull View rootView,
      @NonNull ImageView arrowDown, @NonNull CardView cardViewDeux,
  ...
  @NonNull
  public static SnippetPubChallengeDownloadVideoBinding inflate(@NonNull LayoutInflater inflater,
      @NonNull ViewGroup parent) {
    if (parent == null) {
      throw new NullPointerException("parent");
    }
    inflater.inflate(R.layout.snippet_pub_challenge_download_video, parent);
    return bind(parent);
  }

  @NonNull
  public static SnippetPubChallengeDownloadVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SnippetPubChallengeDownloadVideoBinding(rootView, arrowDown, cardViewDeux,
          deuxEditText, frameBattleVideosDeux, frameUn, lS, lV, linearDeuxEditext, progressbar,
          relLayout6, relLayoutArrowBackCategory, relLayoutCategory, relLayoutGoChooseFollowers,
          relLayoutImgPlayDeux, relLayoutImgPlayUn, relLayoutPublish, switchButton,
          textExplainChallenge, thumbnailDeux, thumbnailUn, toolbar, txtCategory, txtVS,
          unEditText);
    }
