...
public final class ActivityImageUneFullImageBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityImageUneFullImageBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityImageUneFullImageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityImageUneFullImageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_image_une_full_image, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityImageUneFullImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityImageUneFullImageBinding((RelativeLayout) rootView, back, caption, icon,
          image, ivPhoto, ivShare, likeHeart, linLayoutAllMovingViews, linLayoutComment,
