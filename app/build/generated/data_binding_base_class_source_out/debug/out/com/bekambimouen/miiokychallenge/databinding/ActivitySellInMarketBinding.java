...
public final class ActivitySellInMarketBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySellInMarketBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull LinearLayout linLayoutAddPhoto, @NonNull LinearLayout linLayoutProductState,
      @NonNull RelativeLayout menuItem, @NonNull TouchDetectableScrollView nestedScrollView,
      @NonNull TextView number, @NonNull RelativeLayout parent, @NonNull TextView photosMax,
      ...
      @NonNull Toolbar toolBar, @NonNull TextView toolBarText,
  ...
  @NonNull
  public static ActivitySellInMarketBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySellInMarketBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_sell_in_market, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySellInMarketBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySellInMarketBinding((RelativeLayout) rootView, arrowBack,
          ...
          editProductName, fullName, ivVideo, linLayoutAddPhoto, linLayoutProductState, menuItem,
          nestedScrollView, number, parent, photosMax, profilePhoto, progressBar,
          pubRecyclerViewPhoto, radioGroup, radioNew, radioOld, radioSecondHand, recyclerIndicator,
          ...
          relLayoutProfile, relLayoutPublish, relLayoutViewOverlay, textPublish, toolBar,
          toolBarText, toolBarTextviewChoosePhoto, toolbarChoosePhoto, txtCategory, username,
          viewBar, viewBar2);
    }
