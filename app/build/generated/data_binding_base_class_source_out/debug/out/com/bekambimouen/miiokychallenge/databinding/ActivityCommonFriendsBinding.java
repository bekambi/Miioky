...
public final class ActivityCommonFriendsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCommonFriendsBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityCommonFriendsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCommonFriendsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_common_friends, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCommonFriendsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCommonFriendsBinding((RelativeLayout) rootView, arrowBack, editSearch,
          erase, parent, progressBar, recyclerView, relLayoutSearch, relLayoutViewOverlay,
