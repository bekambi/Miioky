...
public final class ActivityGroupSearchInGroupBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupSearchInGroupBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupSearchInGroupBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupSearchInGroupBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_search_in_group, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupSearchInGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupSearchInGroupBinding((RelativeLayout) rootView, arrowBack, editSearch,
