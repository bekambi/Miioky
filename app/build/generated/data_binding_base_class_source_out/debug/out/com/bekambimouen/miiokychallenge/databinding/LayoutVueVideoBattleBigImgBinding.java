...
public final class LayoutVueVideoBattleBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutVueVideoBattleBigImgBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutVueVideoBattleBigImgBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutVueVideoBattleBigImgBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_vue_video_battle_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutVueVideoBattleBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutVueVideoBattleBigImgBinding((LinearLayout) rootView, button, caption,
          category, countryName, downloadedCount, flagIcon, imgPlay, ivShare, linLayoutFlag,
          linLayoutShare, menuItem, point2, profilePhoto, relLayout1, relLayoutCategory,
          relLayoutCountActions, relLayoutDownload, relLayoutGoUserProfile, relLayoutProfile,
          relLayoutShare, shareCount, thumbnail, tpsPublication, translateComment, username,
          viewOnline);
    }
