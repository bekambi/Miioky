...
public final class ActivityLikersBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLikersBinding(@NonNull RelativeLayout rootView, @NonNull RelativeLayout arrowBack,
      @NonNull MyEditText editSearch, @NonNull ImageView erase, @NonNull RelativeLayout parent,
      @NonNull TextView people, @NonNull ProgressBar progressBar,
  ...
  @NonNull
  public static ActivityLikersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLikersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_likers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLikersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLikersBinding((RelativeLayout) rootView, arrowBack, editSearch, erase,
