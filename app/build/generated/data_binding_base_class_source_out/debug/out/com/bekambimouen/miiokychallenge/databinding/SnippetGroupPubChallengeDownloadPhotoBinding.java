...
public final class SnippetGroupPubChallengeDownloadPhotoBinding implements ViewBinding {
  @NonNull
  ...
  private SnippetGroupPubChallengeDownloadPhotoBinding(@NonNull View rootView,
  ...
  @NonNull
  public static SnippetGroupPubChallengeDownloadPhotoBinding inflate(
      @NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
    if (parent == null) {
      throw new NullPointerException("parent");
    }
    inflater.inflate(R.layout.snippet_group_pub_challenge_download_photo, parent);
    return bind(parent);
  }

  @NonNull
  public static SnippetGroupPubChallengeDownloadPhotoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SnippetGroupPubChallengeDownloadPhotoBinding(rootView, arrowDown, cardViewDeux,
