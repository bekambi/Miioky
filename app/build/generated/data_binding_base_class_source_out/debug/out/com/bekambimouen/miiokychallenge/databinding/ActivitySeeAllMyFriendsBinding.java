...
public final class ActivitySeeAllMyFriendsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RelativeLayout relLayoutNoFriends;
  ...
  private ActivitySeeAllMyFriendsBinding(@NonNull RelativeLayout rootView,
      @NonNull MyEditText editSearch, @NonNull ImageView erase, @NonNull ImageView imageView,
      @NonNull TextView noYetPublication, @NonNull RelativeLayout parent,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView recyclerView,
      @NonNull RelativeLayout relLayoutArrowback, @NonNull RelativeLayout relLayoutNoFriends,
    ...
    this.relLayoutNoFriends = relLayoutNoFriends;
  ...
  @NonNull
  public static ActivitySeeAllMyFriendsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySeeAllMyFriendsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_see_all_my_friends, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySeeAllMyFriendsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.relLayout_no_friends;
      RelativeLayout relLayoutNoFriends = ViewBindings.findChildViewById(rootView, id);
      if (relLayoutNoFriends == null) {
        break missingId;
      }
      ...
      return new ActivitySeeAllMyFriendsBinding((RelativeLayout) rootView, editSearch, erase,
          imageView, noYetPublication, parent, progressBar, recyclerView, relLayoutArrowback,
          relLayoutNoFriends, relLayoutSearch, relLayoutViewOverlay, searchIdWhite, toolBar);
    }
