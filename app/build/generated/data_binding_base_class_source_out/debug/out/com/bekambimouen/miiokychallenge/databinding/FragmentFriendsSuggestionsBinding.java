...
public final class FragmentFriendsSuggestionsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFriendsSuggestionsBinding(@NonNull RelativeLayout rootView,
      @NonNull MyEditText editSearch, @NonNull ImageView erase, @NonNull ProgressBar progressBar,
  ...
  @NonNull
  public static FragmentFriendsSuggestionsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFriendsSuggestionsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_friends_suggestions, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFriendsSuggestionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFriendsSuggestionsBinding((RelativeLayout) rootView, editSearch, erase,
          progressBar, recyclerView, relLayoutSearch, relLayoutViewOverlay, searchIdWhite);
    }
