...
public final class LayoutCommentResponseBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutCommentResponseBinding(@NonNull RelativeLayout rootView, @NonNull CardView cardView,
      @NonNull ViewMoreTextView comment, @NonNull TextView commentLikes,
      ...
      @NonNull RelativeLayout deletedComment, @NonNull ImageView image, @NonNull ImageView imgPlay,
      @NonNull SmallBangView likeHeart, @NonNull RelativeLayout likes, @NonNull ImageView menuItem,
  ...
  @NonNull
  public static LayoutCommentResponseBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutCommentResponseBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_comment_response, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutCommentResponseBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutCommentResponseBinding((RelativeLayout) rootView, cardView, comment,
          commentLikes, commentProfileImage, commentReply, commentTimePosted, commentUsername,
          deletedComment, image, imgPlay, likeHeart, likes, menuItem, parent, relLayout1,
          relLayoutImgPlay, relLayoutMenuItem, thumbnail);
    }
