...
public final class ActivitySeeAllSuggestionsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySeeAllSuggestionsBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivitySeeAllSuggestionsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySeeAllSuggestionsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_see_all_suggestions, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySeeAllSuggestionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySeeAllSuggestionsBinding((RelativeLayout) rootView, arrowBack, editSearch,
          erase, parent, progressBar, recyclerView, relLayoutNoConnxion, relLayoutSearch,
          relLayoutViewOverlay, searchIdWhite, toolBar, toolBarTextview);
    }
