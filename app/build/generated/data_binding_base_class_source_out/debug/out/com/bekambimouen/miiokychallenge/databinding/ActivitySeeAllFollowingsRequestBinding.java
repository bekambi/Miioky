...
public final class ActivitySeeAllFollowingsRequestBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySeeAllFollowingsRequestBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout arrowBack, @NonNull ImageView close, @NonNull RelativeLayout main,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView recyclerViewSubscriptionRequest,
  ...
  @NonNull
  public static ActivitySeeAllFollowingsRequestBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySeeAllFollowingsRequestBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_see_all_followings_request, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySeeAllFollowingsRequestBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySeeAllFollowingsRequestBinding((RelativeLayout) rootView, arrowBack, close,
          main, progressBar, recyclerViewSubscriptionRequest, relLayoutViewOverlay, toolBar,
          toolBarTextview);
    }
