...
public final class LayoutViewCategoryImageBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutViewCategoryImageBigImgBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutViewCategoryImageBigImgBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutViewCategoryImageBigImgBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_view_category_image_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutViewCategoryImageBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutViewCategoryImageBigImgBinding((LinearLayout) rootView, buttonFollow,
          caption, category, countryName, downloadedCount, flagIcon, imageInvite, ivShare,
          ...
          relLayoutGoUserProfile, relLayoutProfile, relLayoutShare, shareCount, tpsPublication,
