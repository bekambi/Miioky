...
public final class ActivityResponseImageDoubleFullImageShareBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityResponseImageDoubleFullImageShareBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityResponseImageDoubleFullImageShareBinding inflate(
  ...
  public static ActivityResponseImageDoubleFullImageShareBinding inflate(
    ...
    View root = inflater.inflate(R.layout.activity_response_image_double_full_image_share, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityResponseImageDoubleFullImageShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResponseImageDoubleFullImageShareBinding((RelativeLayout) rootView, back,
          caption, category, icon, ivShare, linLayoutAllData, linLayoutComment, linLayoutShare,
          menuItem, messagePhotoInsta, numberOfComments, numberOfShare, parent, recyclerView,
