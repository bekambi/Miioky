...
public final class LayoutFriendSeeAllUserHisFriendsBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutFriendSeeAllUserHisFriendsBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView textFriend, @NonNull TextView username) {
  ...
  @NonNull
  public static LayoutFriendSeeAllUserHisFriendsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutFriendSeeAllUserHisFriendsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_friend_see_all_user_his_friends, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutFriendSeeAllUserHisFriendsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutFriendSeeAllUserHisFriendsBinding((RelativeLayout) rootView, buttonFollow,
          buttonSent, buttonUnfollow, fullName, linLayoutUsername, memberI, memberIi,
          ...
          relLayoutProfileFriends, relLayoutUnfriend, textFriend, username);
    }
