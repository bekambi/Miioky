...
public final class FragmentNotificationBinding implements ViewBinding {
  ...
  private FragmentNotificationBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull RelativeLayout relLayoutViewOverlay, @NonNull TextView story) {
  ...
  public static FragmentNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.story;
      TextView story = ViewBindings.findChildViewById(rootView, id);
      if (story == null) {
        break missingId;
      }

      return new FragmentNotificationBinding((RelativeLayout) rootView, progressBar, recyclerView,
          relLayoutViewOverlay, story);
    }
