...
public final class ActivityGroupInviteNewMembersBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupInviteNewMembersBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout arrowBack, @NonNull ImageView close, @NonNull MyEditText editSearch,
      @NonNull TextView emptyList, @NonNull ImageView erase, @NonNull ImageView imageView,
  ...
  @NonNull
  public static ActivityGroupInviteNewMembersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupInviteNewMembersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_invite_new_members, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupInviteNewMembersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupInviteNewMembersBinding((RelativeLayout) rootView, arrowBack, close,
          editSearch, emptyList, erase, imageView, loadingProgressBar, parent, recyclerView,
          relLayoutEmptyList, relLayoutSearch, relLayoutViewOverlay, searchIdWhite, toolBar,
          toolBarTextview, tvSuggestion);
    }
