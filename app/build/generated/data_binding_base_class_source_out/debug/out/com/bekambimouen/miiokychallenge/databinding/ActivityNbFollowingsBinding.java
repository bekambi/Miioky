...
public final class ActivityNbFollowingsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityNbFollowingsBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView arrowBack, @NonNull MyEditText editSearch, @NonNull TextView emptyList,
      @NonNull ImageView erase, @NonNull ImageView imageView, @NonNull RelativeLayout parent,
      ...
      @NonNull ImageView searchIdWhite, @NonNull Toolbar toolbar) {
  ...
  @NonNull
  public static ActivityNbFollowingsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityNbFollowingsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_nb_followings, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityNbFollowingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNbFollowingsBinding((RelativeLayout) rootView, arrowBack, editSearch,
          emptyList, erase, imageView, parent, recyclerView, relLayoutEmptyList, relLayoutSearch,
          relLayoutViewOverlay, searchIdWhite, toolbar);
    }
