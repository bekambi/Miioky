...
public final class ActivityRecyclerFullImageShareBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityRecyclerFullImageShareBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityRecyclerFullImageShareBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityRecyclerFullImageShareBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_recycler_full_image_share, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityRecyclerFullImageShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityRecyclerFullImageShareBinding((RelativeLayout) rootView, addDescription,
