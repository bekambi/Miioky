...
public final class ActivityGroupFullChallengeVideoShareBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupFullChallengeVideoShareBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupFullChallengeVideoShareBinding inflate(
  ...
  public static ActivityGroupFullChallengeVideoShareBinding inflate(
    ...
    View root = inflater.inflate(R.layout.activity_group_full_challenge_video_share, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupFullChallengeVideoShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupFullChallengeVideoShareBinding((RelativeLayout) rootView, caption,
