...
public final class ActivityGroupImageUneFullImageBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupImageUneFullImageBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull TextView numberOfShare, @NonNull RelativeLayout parent,
  ...
  @NonNull
  public static ActivityGroupImageUneFullImageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupImageUneFullImageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_image_une_full_image, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupImageUneFullImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupImageUneFullImageBinding((RelativeLayout) rootView, back, caption,
          icon, image, ivPhoto, ivShare, likeHeart, linLayoutAllMovingViews, linLayoutComment,
          linLayoutLike, linLayoutLikeAndComment, linLayoutShare, menuItem, messagePhotoInsta,
