...
public final class ActivityGroupRecyclerFullImageBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupRecyclerFullImageBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupRecyclerFullImageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupRecyclerFullImageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_recycler_full_image, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupRecyclerFullImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupRecyclerFullImageBinding((RelativeLayout) rootView, addDescription,
          back, caption, icon, image, imageview, ivShare, likeHeart, linLayoutAddDescription,
