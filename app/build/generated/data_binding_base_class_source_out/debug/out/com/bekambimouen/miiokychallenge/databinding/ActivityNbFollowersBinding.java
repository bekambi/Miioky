...
public final class ActivityNbFollowersBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityNbFollowersBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout arrowBack, @NonNull MyEditText editSearch,
      ...
      @NonNull RelativeLayout relLayoutEmptyList, @NonNull RelativeLayout relLayoutSearch,
  ...
  @NonNull
  public static ActivityNbFollowersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityNbFollowersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_nb_followers, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityNbFollowersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNbFollowersBinding((RelativeLayout) rootView, arrowBack, editSearch,
