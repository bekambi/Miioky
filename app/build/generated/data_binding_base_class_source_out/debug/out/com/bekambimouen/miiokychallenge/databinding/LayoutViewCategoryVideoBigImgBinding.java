...
public final class LayoutViewCategoryVideoBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutViewCategoryVideoBigImgBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull ImageView imgPlay, @NonNull ImageView ivShare, @NonNull LinearLayout linLayoutFlag,
      @NonNull LinearLayout linLayoutShare, @NonNull ImageView menuItem, @NonNull View point1,
  ...
  @NonNull
  public static LayoutViewCategoryVideoBigImgBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutViewCategoryVideoBigImgBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_view_category_video_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutViewCategoryVideoBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutViewCategoryVideoBigImgBinding((LinearLayout) rootView, buttonFollow,
          caption, category, countryName, downloadedCount, flagIcon, imgPlay, ivShare,
          linLayoutFlag, linLayoutShare, menuItem, point1, point2, profilePhoto, relLayout1,
          relLayoutCategory, relLayoutCountActions, relLayoutDownload, relLayoutFollow,
          relLayoutGoUserProfile, relLayoutProfile, relLayoutShare, shareCount, thumbnail,
