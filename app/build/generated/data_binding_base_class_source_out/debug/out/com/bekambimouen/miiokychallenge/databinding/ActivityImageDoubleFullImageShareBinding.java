...
public final class ActivityImageDoubleFullImageShareBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityImageDoubleFullImageShareBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityImageDoubleFullImageShareBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityImageDoubleFullImageShareBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_image_double_full_image_share, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityImageDoubleFullImageShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityImageDoubleFullImageShareBinding((RelativeLayout) rootView, back, caption,
