...
public final class ActivityGroupResponseImageDoubleFullImageShareBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupResponseImageDoubleFullImageShareBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull RecyclerView recyclerView, @NonNull RelativeLayout relLayoutUsername,
  ...
  @NonNull
  public static ActivityGroupResponseImageDoubleFullImageShareBinding inflate(
  ...
  public static ActivityGroupResponseImageDoubleFullImageShareBinding inflate(
    ...
    View root = inflater.inflate(R.layout.activity_group_response_image_double_full_image_share, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupResponseImageDoubleFullImageShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupResponseImageDoubleFullImageShareBinding((RelativeLayout) rootView,
          addDescription, back, caption, category, icon, imageview, ivShare,
          linLayoutAddDescription, linLayoutAllData, linLayoutComment, linLayoutShare, menuItem,
