...
public final class LayoutVueUserImageBattleBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutVueUserImageBattleBigImgBinding(@NonNull LinearLayout rootView,
      @NonNull TextView button, @NonNull ViewMoreTextView caption, @NonNull TextView category,
      @NonNull TextView downloadedCount, @NonNull ImageView icon, @NonNull ImageView imageInvite,
  ...
  @NonNull
  public static LayoutVueUserImageBattleBigImgBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutVueUserImageBattleBigImgBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_vue_user_image_battle_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutVueUserImageBattleBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutVueUserImageBattleBigImgBinding((LinearLayout) rootView, button, caption,
          category, downloadedCount, icon, imageInvite, ivShare, linLayoutShare, menuItem,
