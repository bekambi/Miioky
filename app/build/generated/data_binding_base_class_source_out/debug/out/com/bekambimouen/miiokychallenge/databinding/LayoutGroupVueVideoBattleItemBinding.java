...
public final class LayoutGroupVueVideoBattleItemBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupVueVideoBattleItemBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutGroupVueVideoBattleItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGroupVueVideoBattleItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_group_vue_video_battle_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupVueVideoBattleItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupVueVideoBattleItemBinding((LinearLayout) rootView, admin, button,
