...
public final class ActivityChatContactsBinding implements ViewBinding {
  ...
  private ActivityChatContactsBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout arrowBack, @NonNull MyEditText editSearch, @NonNull ImageView erase,
      @NonNull ImageView menuItem, @NonNull RelativeLayout parent, @NonNull ProgressBar progressBar,
  ...
  public static ActivityChatContactsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityChatContactsBinding((RelativeLayout) rootView, arrowBack, editSearch,
          erase, menuItem, parent, progressBar, recyclerView, relLayoutSearch, relLayoutViewOverlay,
