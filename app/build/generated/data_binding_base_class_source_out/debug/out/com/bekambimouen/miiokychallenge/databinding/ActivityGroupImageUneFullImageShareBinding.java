...
public final class ActivityGroupImageUneFullImageShareBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupImageUneFullImageShareBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupImageUneFullImageShareBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static ActivityGroupImageUneFullImageShareBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.activity_group_image_une_full_image_share, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupImageUneFullImageShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupImageUneFullImageShareBinding((RelativeLayout) rootView, back,
          caption, icon, image, ivPhoto, ivShare, likeHeart, linLayoutAllMovingViews,
          linLayoutComment, linLayoutLike, linLayoutShare, menuItem, messagePhotoInsta,
          numberOfComments, numberOfLikes, numberOfShare, parent, relLayoutUsername,
