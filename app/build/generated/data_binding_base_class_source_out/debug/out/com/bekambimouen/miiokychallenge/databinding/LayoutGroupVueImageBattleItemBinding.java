...
public final class LayoutGroupVueImageBattleItemBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupVueImageBattleItemBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutGroupVueImageBattleItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGroupVueImageBattleItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_group_vue_image_battle_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupVueImageBattleItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupVueImageBattleItemBinding((LinearLayout) rootView, admin, button,
