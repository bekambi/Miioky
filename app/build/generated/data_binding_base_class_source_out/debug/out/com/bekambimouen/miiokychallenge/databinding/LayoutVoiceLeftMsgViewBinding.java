...
public final class LayoutVoiceLeftMsgViewBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RelativeLayout relLayoutSeekbar;
  ...
  private LayoutVoiceLeftMsgViewBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull RelativeLayout relLayout, @NonNull RelativeLayout relLayoutSeekbar,
      @NonNull SeekBar seekBar, @NonNull TextView totalTxtTime, @NonNull TextView txtTime) {
    ...
    this.relLayoutSeekbar = relLayoutSeekbar;
  ...
  @NonNull
  public static LayoutVoiceLeftMsgViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutVoiceLeftMsgViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_voice_left_msg_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutVoiceLeftMsgViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.relLayout_seekbar;
      RelativeLayout relLayoutSeekbar = ViewBindings.findChildViewById(rootView, id);
      if (relLayoutSeekbar == null) {
        break missingId;
      }
      ...
      return new LayoutVoiceLeftMsgViewBinding((RelativeLayout) rootView, collectorLinearLayout,
          imgPlay, paddedLinearLayout, profilPhoto, relLayout, relLayoutSeekbar, seekBar,
          totalTxtTime, txtTime);
    }
