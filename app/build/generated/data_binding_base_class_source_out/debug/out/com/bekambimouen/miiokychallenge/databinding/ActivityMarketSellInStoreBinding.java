...
public final class ActivityMarketSellInStoreBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LinearLayout linLayoutProductState;
  ...
  @NonNull
  public final AppCompatRadioButton radioSecondHand;
  ...
  private ActivityMarketSellInStoreBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull MyEditText editDescription, @NonNull MyEditText editOldPrice,
      @NonNull MyEditText editPrice, @NonNull MyEditText editProductName,
      @NonNull ImageView ivVideo, @NonNull LinearLayout linLayoutAddPhoto,
      @NonNull LinearLayout linLayoutProductState, @NonNull RelativeLayout menuItem,
      ...
      @NonNull RecyclerView pubRecyclerViewPhoto, @NonNull ToggleButtonGroupTableLayout radioGroup,
      @NonNull AppCompatRadioButton radioNew, @NonNull AppCompatRadioButton radioOld,
      @NonNull AppCompatRadioButton radioSecondHand,
      ...
      @NonNull RelativeLayout relLayoutArrowBackChoosePhoto,
      ...
      @NonNull RelativeLayout relLayoutOldPrice, @NonNull RelativeLayout relLayoutPhoto,
      @NonNull RelativeLayout relLayoutPicPhoto, @NonNull RelativeLayout relLayoutPost,
      @NonNull RelativeLayout relLayoutPostProduct, @NonNull RelativeLayout relLayoutPrice,
      @NonNull RelativeLayout relLayoutProduct, @NonNull RelativeLayout relLayoutProfile,
      @NonNull RelativeLayout relLayoutPublish, @NonNull RelativeLayout relLayoutViewOverlay,
      @NonNull TextView storeName, @NonNull TextView textPublish, @NonNull Toolbar toolBar,
      @NonNull TextView toolBarText, @NonNull TextView toolBarTextviewChoosePhoto,
      @NonNull Toolbar toolbarChoosePhoto, @NonNull TextView txtCategory, @NonNull View viewBar,
      @NonNull View viewBar2) {
    ...
    this.linLayoutProductState = linLayoutProductState;
    ...
    this.radioOld = radioOld;
    this.radioSecondHand = radioSecondHand;
  ...
  @NonNull
  public static ActivityMarketSellInStoreBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMarketSellInStoreBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_market_sell_in_store, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMarketSellInStoreBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.linLayout_product_state;
      LinearLayout linLayoutProductState = ViewBindings.findChildViewById(rootView, id);
      if (linLayoutProductState == null) {
        break missingId;
      }
      ...
      id = R.id.radio_new;
      AppCompatRadioButton radioNew = ViewBindings.findChildViewById(rootView, id);
      if (radioNew == null) {
        break missingId;
      }

      id = R.id.radio_old;
      AppCompatRadioButton radioOld = ViewBindings.findChildViewById(rootView, id);
      if (radioOld == null) {
        break missingId;
      }

      id = R.id.radio_second_hand;
      AppCompatRadioButton radioSecondHand = ViewBindings.findChildViewById(rootView, id);
      if (radioSecondHand == null) {
        break missingId;
      }
      ...
      return new ActivityMarketSellInStoreBinding((RelativeLayout) rootView, arrowBack,
          arrowBackChoosePhoto, arrowDown, buttonOk, cameraId, close, countryDevise1,
          countryDevise2, editDescription, editOldPrice, editPrice, editProductName, ivVideo,
          linLayoutAddPhoto, linLayoutProductState, menuItem, nestedScrollView, number, parent,
          photosMax, profilePhoto, progressBar, pubRecyclerViewPhoto, radioGroup, radioNew,
          radioOld, radioSecondHand, recyclerIndicator, recyclerView, relLayout, relLayout4,
          relLayout51, relLayout52, relLayout6, relLayout7, relLayoutArrowBackChoosePhoto,
          relLayoutButtonOk, relLayoutCategory, relLayoutDescription, relLayoutGoUserProfile,
          relLayoutOldPrice, relLayoutPhoto, relLayoutPicPhoto, relLayoutPost, relLayoutPostProduct,
          relLayoutPrice, relLayoutProduct, relLayoutProfile, relLayoutPublish,
          relLayoutViewOverlay, storeName, textPublish, toolBar, toolBarText,
          toolBarTextviewChoosePhoto, toolbarChoosePhoto, txtCategory, viewBar, viewBar2);
    }
