...
public final class ActivityGroupImageDoubleFullImageBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupImageDoubleFullImageBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupImageDoubleFullImageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupImageDoubleFullImageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_image_double_full_image, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupImageDoubleFullImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupImageDoubleFullImageBinding((RelativeLayout) rootView, addDescription,
          back, caption, category, icon, imageview, ivShare, linLayoutAddDescription,
          linLayoutAllData, linLayoutComment, linLayoutLikeAndComment, linLayoutShare, menuItem,
