...
public final class SnippetGroupPubChallengeDownloadVideoBinding implements ViewBinding {
  @NonNull
  ...
  private SnippetGroupPubChallengeDownloadVideoBinding(@NonNull View rootView,
  ...
  @NonNull
  public static SnippetGroupPubChallengeDownloadVideoBinding inflate(
      @NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
    if (parent == null) {
      throw new NullPointerException("parent");
    }
    inflater.inflate(R.layout.snippet_group_pub_challenge_download_video, parent);
    return bind(parent);
  }

  @NonNull
  public static SnippetGroupPubChallengeDownloadVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SnippetGroupPubChallengeDownloadVideoBinding(rootView, arrowDown, cardViewDeux,
