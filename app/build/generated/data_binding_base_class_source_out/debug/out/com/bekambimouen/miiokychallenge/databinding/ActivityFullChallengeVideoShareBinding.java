...
public final class ActivityFullChallengeVideoShareBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFullChallengeVideoShareBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityFullChallengeVideoShareBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFullChallengeVideoShareBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_full_challenge_video_share, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFullChallengeVideoShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFullChallengeVideoShareBinding((RelativeLayout) rootView, caption,
