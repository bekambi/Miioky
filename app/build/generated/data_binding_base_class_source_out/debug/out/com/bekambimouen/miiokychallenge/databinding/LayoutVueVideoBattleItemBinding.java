...
public final class LayoutVueVideoBattleItemBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutVueVideoBattleItemBinding(@NonNull LinearLayout rootView, @NonNull TextView button,
      @NonNull ViewMoreTextView caption, @NonNull TextView category, @NonNull TextView countryName,
      @NonNull TextView downloadedCount, @NonNull ImageView flagIcon, @NonNull ImageView imgPlay,
      @NonNull ImageView ivShare, @NonNull LinearLayout linLayoutFlag,
      @NonNull LinearLayout linLayoutShare, @NonNull ImageView menuItem, @NonNull View point2,
  ...
  @NonNull
  public static LayoutVueVideoBattleItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutVueVideoBattleItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_vue_video_battle_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutVueVideoBattleItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutVueVideoBattleItemBinding((LinearLayout) rootView, button, caption, category,
          countryName, downloadedCount, flagIcon, imgPlay, ivShare, linLayoutFlag, linLayoutShare,
          menuItem, point2, profilePhoto, relLayout1, relLayoutCategory, relLayoutCountActions,
          relLayoutDownload, relLayoutGoUserProfile, relLayoutProfile, relLayoutShare, shareCount,
          thumbnail, tpsPublication, translateComment, username, viewOnline);
    }
