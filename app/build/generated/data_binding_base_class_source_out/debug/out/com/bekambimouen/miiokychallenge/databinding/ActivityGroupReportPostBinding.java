...
public final class ActivityGroupReportPostBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RelativeLayout relLayoutNoContentReport;
  ...
  private ActivityGroupReportPostBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull RecyclerView recyclerView, @NonNull RelativeLayout relLayoutNoContentReport,
    ...
    this.relLayoutNoContentReport = relLayoutNoContentReport;
  ...
  @NonNull
  public static ActivityGroupReportPostBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupReportPostBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_report_post, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupReportPostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.relLayout_no_content_report;
      RelativeLayout relLayoutNoContentReport = ViewBindings.findChildViewById(rootView, id);
      if (relLayoutNoContentReport == null) {
        break missingId;
      }
      ...
      return new ActivityGroupReportPostBinding((RelativeLayout) rootView, arrowBack, close,
          imageView, loadingProgressBar, noContentReport, parent, progressBar, recyclerView,
          relLayoutNoContentReport, relLayoutViewOverlay, toolBar, toolBarTextview);
    }
