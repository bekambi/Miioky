...
public final class ActivityGroupPubCommentTextBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupPubCommentTextBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull CardView gradientYellowPinkDarkViolet,
  ...
  @NonNull
  public static ActivityGroupPubCommentTextBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupPubCommentTextBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_pub_comment_text, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupPubCommentTextBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupPubCommentTextBinding((RelativeLayout) rootView, arrowBack, close,
          ...
          progressBar, relLayoutEdittextCadre, relLayoutGoUserProfile, relLayoutProfile,
          relLayoutPublish, relLayoutViewOverlay, textPublish, toolBar, toolBarText, username);
    }
