...
public final class LayoutViewCategoryVideoBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutViewCategoryVideoBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutViewCategoryVideoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutViewCategoryVideoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_view_category_video, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutViewCategoryVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutViewCategoryVideoBinding((LinearLayout) rootView, buttonFollow, caption,
