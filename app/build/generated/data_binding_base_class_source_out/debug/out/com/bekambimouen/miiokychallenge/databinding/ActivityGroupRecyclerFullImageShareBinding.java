...
public final class ActivityGroupRecyclerFullImageShareBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupRecyclerFullImageShareBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupRecyclerFullImageShareBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static ActivityGroupRecyclerFullImageShareBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.activity_group_recycler_full_image_share, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupRecyclerFullImageShareBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupRecyclerFullImageShareBinding((RelativeLayout) rootView,
          addDescription, back, caption, icon, image, imageview, ivShare, likeHeart,
          linLayoutAddDescription, linLayoutAllData, linLayoutComment, linLayoutLike,
          linLayoutShare, menuItem, messagePhotoInsta, numberOfComments, numberOfLikes,
          numberOfShare, parent, recyclerView, relLayoutUsername, relLayoutViewOverlay,
          relLayoutWriteTo, text, theUser, tpsPublication, translateComment, username);
    }
