...
public final class ActivityGroupViewAdminBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupViewAdminBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout arrowBack, @NonNull CardView cardView, @NonNull ImageView close,
      @NonNull LinearLayout linLayoutChallenges, @NonNull LinearLayout linLayoutParent,
      @NonNull LinearLayout linLayoutPublisher, @NonNull LinearLayout linLayoutThought,
      @NonNull RelativeLayout parent, @NonNull ImageView profilePhotoToolbar,
  ...
  @NonNull
  public static ActivityGroupViewAdminBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupViewAdminBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_view_admin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupViewAdminBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupViewAdminBinding((RelativeLayout) rootView, arrowBack, cardView,
          close, linLayoutChallenges, linLayoutParent, linLayoutPublisher, linLayoutThought, parent,
          profilePhotoToolbar, recyclerView, relLayoutBoard, relLayoutChallenges,
