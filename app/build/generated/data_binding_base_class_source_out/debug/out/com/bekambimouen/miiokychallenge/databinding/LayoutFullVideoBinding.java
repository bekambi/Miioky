...
public final class LayoutFullVideoBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutFullVideoBinding(@NonNull RelativeLayout rootView, @NonNull FrameLayout frameLayout,
      @NonNull ImageView imgPlay, @NonNull ImageView imgVol, @NonNull PlayerView playerView,
      @NonNull ProgressBar progressBar, @NonNull RelativeLayout relLayoutImgPlay,
  ...
  @NonNull
  public static LayoutFullVideoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutFullVideoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_full_video, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutFullVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutFullVideoBinding((RelativeLayout) rootView, frameLayout, imgPlay, imgVol,
