...
public final class LayoutGroupViewVideoUneBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final FrameLayout aspectRationFrameLayout;
  ...
  private LayoutGroupViewVideoUneBinding(@NonNull LinearLayout rootView, @NonNull TextView admin,
      @NonNull FrameLayout aspectRationFrameLayout, @NonNull ViewMoreTextView caption,
      ...
      @NonNull RelativeLayout relVol, @NonNull ImageView thumbnail,
    ...
    this.admin = admin;
    this.aspectRationFrameLayout = aspectRationFrameLayout;
  ...
  @NonNull
  public static LayoutGroupViewVideoUneBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGroupViewVideoUneBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_group_view_video_une, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupViewVideoUneBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.aspect_ration_frame_layout;
      FrameLayout aspectRationFrameLayout = ViewBindings.findChildViewById(rootView, id);
      if (aspectRationFrameLayout == null) {
        break missingId;
      }
      ...
      return new LayoutGroupViewVideoUneBinding((LinearLayout) rootView, admin,
          aspectRationFrameLayout, caption, cardView, connerBigStarIcon, crushMsg, groupName,
          ...
          playerView, point, point1, profilePhoto, progressBar, relLayoutAdmin, relLayoutGroupName,
          relLayoutImgPlay, relLayoutProfile, relLayoutPublisher, relLayoutUsername, relVol,
