...
public final class FragmentAllUserFriendsBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentAllUserFriendsBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static FragmentAllUserFriendsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentAllUserFriendsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_all_user_friends, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentAllUserFriendsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentAllUserFriendsBinding((RelativeLayout) rootView, editSearch, erase,
