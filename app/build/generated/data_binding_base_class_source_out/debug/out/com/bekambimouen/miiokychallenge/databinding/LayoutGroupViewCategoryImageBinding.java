...
public final class LayoutGroupViewCategoryImageBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupViewCategoryImageBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutGroupViewCategoryImageBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGroupViewCategoryImageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_group_view_category_image, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupViewCategoryImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupViewCategoryImageBinding((LinearLayout) rootView, caption, cardView,
          category, countryName, downloadedCount, flagIcon, groupName, groupProfilePhoto,
