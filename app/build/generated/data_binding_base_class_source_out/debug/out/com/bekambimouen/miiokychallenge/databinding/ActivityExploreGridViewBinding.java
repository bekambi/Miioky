...
public final class ActivityExploreGridViewBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityExploreGridViewBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityExploreGridViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityExploreGridViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_explore_grid_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityExploreGridViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityExploreGridViewBinding((RelativeLayout) rootView, parent, progressBar,
          recyclerView, relLayoutSearch, relLayoutViewOverlay, searchIdWhite);
    }
