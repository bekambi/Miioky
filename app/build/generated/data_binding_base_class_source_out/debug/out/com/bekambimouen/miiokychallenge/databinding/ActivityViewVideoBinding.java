...
public final class ActivityViewVideoBinding implements ViewBinding {
  ...
  private ActivityViewVideoBinding(@NonNull RelativeLayout rootView, @NonNull ImageView imgPlay,
      @NonNull ImageView imgViewfun, @NonNull RelativeLayout parent,
      @NonNull Toolbar profileToolBar, @NonNull ProgressBar progressBar,
      @NonNull Container recyclerView, @NonNull RelativeLayout relLayout,
      @NonNull RelativeLayout relLayoutIconHome, @NonNull RelativeLayout relLayoutImgPlay,
      @NonNull RelativeLayout relLayoutImgPlayRed, @NonNull RelativeLayout relLayoutMenu,
      @NonNull RelativeLayout relLayoutViewOverlay, @NonNull View view, @NonNull View view2) {
  ...
  @NonNull
  public static ActivityViewVideoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityViewVideoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_view_video, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityViewVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityViewVideoBinding((RelativeLayout) rootView, imgPlay, imgViewfun, parent,
          profileToolBar, progressBar, recyclerView, relLayout, relLayoutIconHome, relLayoutImgPlay,
          relLayoutImgPlayRed, relLayoutMenu, relLayoutViewOverlay, view, view2);
    }
