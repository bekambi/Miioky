...
public final class ActivityGroupInvitPersonsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupInvitPersonsBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupInvitPersonsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupInvitPersonsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_group_invit_persons, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupInvitPersonsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupInvitPersonsBinding((RelativeLayout) rootView, arrowBack, editSearch,
