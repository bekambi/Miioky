...
public final class LayoutGroupVueUserVideoBattleItemBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupVueUserVideoBattleItemBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static LayoutGroupVueUserVideoBattleItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutGroupVueUserVideoBattleItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_group_vue_user_video_battle_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupVueUserVideoBattleItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupVueUserVideoBattleItemBinding((LinearLayout) rootView, admin, button,
