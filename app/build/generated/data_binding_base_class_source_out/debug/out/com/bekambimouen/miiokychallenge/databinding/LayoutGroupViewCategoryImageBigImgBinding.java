...
public final class LayoutGroupViewCategoryImageBigImgBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutGroupViewCategoryImageBigImgBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull ImageView menuItem, @NonNull View point, @NonNull View point2,
      ...
      @NonNull RelativeLayout relLayoutDownload, @NonNull RelativeLayout relLayoutGoUserProfile,
  ...
  @NonNull
  public static LayoutGroupViewCategoryImageBigImgBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static LayoutGroupViewCategoryImageBigImgBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.layout_group_view_category_image_big_img, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutGroupViewCategoryImageBigImgBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutGroupViewCategoryImageBigImgBinding((LinearLayout) rootView, caption,
          cardView, category, countryName, downloadedCount, flagIcon, groupName, groupProfilePhoto,
          imageInvite, ivShare, joinGroup, linLayoutFlag, linLayoutShare, menuItem, point, point2,
          ...
          relLayoutUsername, shareCount, tpsPublication, translateComment, username, viewOnline);
    }
