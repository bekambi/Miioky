...
public final class ActivityGroupsFollowingBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupsFollowingBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupsFollowingBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityGroupsFollowingBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_groups_following, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupsFollowingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupsFollowingBinding((RelativeLayout) rootView, arrowBack, editSearch,
