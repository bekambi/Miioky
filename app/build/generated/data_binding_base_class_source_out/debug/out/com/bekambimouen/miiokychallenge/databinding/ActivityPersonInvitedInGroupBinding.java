...
public final class ActivityPersonInvitedInGroupBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RelativeLayout relLayoutNoneInvitationSent;
  ...
  private ActivityPersonInvitedInGroupBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout arrowBack, @NonNull ImageView close, @NonNull MyEditText editSearch,
      @NonNull ImageView erase, @NonNull ImageView imageView, @NonNull TextView inviteFriends,
      @NonNull ProgressBar loadingProgressBar, @NonNull TextView noYetPublication,
      @NonNull RelativeLayout parent, @NonNull RecyclerView recyclerView,
      @NonNull RelativeLayout relLayoutNoneInvitationSent, @NonNull RelativeLayout relLayoutSearch,
    ...
    this.relLayoutNoneInvitationSent = relLayoutNoneInvitationSent;
  ...
  @NonNull
  public static ActivityPersonInvitedInGroupBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPersonInvitedInGroupBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_person_invited_in_group, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPersonInvitedInGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.relLayout_none_invitation_sent;
      RelativeLayout relLayoutNoneInvitationSent = ViewBindings.findChildViewById(rootView, id);
      if (relLayoutNoneInvitationSent == null) {
        break missingId;
      }
      ...
      return new ActivityPersonInvitedInGroupBinding((RelativeLayout) rootView, arrowBack, close,
          editSearch, erase, imageView, inviteFriends, loadingProgressBar, noYetPublication, parent,
          recyclerView, relLayoutNoneInvitationSent, relLayoutSearch, relLayoutViewOverlay,
          searchIdWhite, toolBar, toolBarTextview);
    }
