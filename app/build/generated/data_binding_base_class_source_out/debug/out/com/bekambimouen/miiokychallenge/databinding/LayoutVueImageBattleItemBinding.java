...
public final class LayoutVueImageBattleItemBinding implements ViewBinding {
  @NonNull
  ...
  private LayoutVueImageBattleItemBinding(@NonNull LinearLayout rootView, @NonNull TextView button,
      @NonNull ViewMoreTextView caption, @NonNull TextView category, @NonNull TextView countryName,
      @NonNull TextView downloadedCount, @NonNull ImageView flagIcon,
      ...
      @NonNull ImageView menuItem, @NonNull View point2, @NonNull CircleImageView profilePhoto,
  ...
  @NonNull
  public static LayoutVueImageBattleItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LayoutVueImageBattleItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.layout_vue_image_battle_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LayoutVueImageBattleItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutVueImageBattleItemBinding((LinearLayout) rootView, button, caption, category,
          countryName, downloadedCount, flagIcon, imageInvite, ivShare, linLayoutFlag,
          ...
          relLayoutShare, shareCount, tpsPublication, translateComment, username, viewOnline);
    }
