...
public final class FragmentChatBinding implements ViewBinding {
  ...
  @NonNull
  public final RelativeLayout relLayoutContacts;
  ...
  private FragmentChatBinding(@NonNull RelativeLayout rootView, @NonNull MyEditText editSearch,
      @NonNull ImageView erase, @NonNull ProgressBar progressBar,
      @NonNull RecyclerView recyclerView, @NonNull RelativeLayout relLayoutContacts,
    ...
    this.relLayoutContacts = relLayoutContacts;
  ...
  public static FragmentChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.relLayout_contacts;
      RelativeLayout relLayoutContacts = ViewBindings.findChildViewById(rootView, id);
      if (relLayoutContacts == null) {
        break missingId;
      }
      ...
      return new FragmentChatBinding((RelativeLayout) rootView, editSearch, erase, progressBar,
          recyclerView, relLayoutContacts, relLayoutSearch, relLayoutViewOverlay, searchIdWhite);
    }
