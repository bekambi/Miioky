...
public final class MsgItemLeftBinding implements ViewBinding {
  ...
  private MsgItemLeftBinding(@NonNull LinearLayout rootView, @NonNull TextView date,
      @NonNull RelativeLayout deletedComment, @NonNull TextView hour, @NonNull TextView hourPhoto,
      ...
      @NonNull LinearLayout linLayout, @NonNull LinearLayout linLayout2,
      @NonNull LinearLayout linLayoutSimpleMessage, @NonNull LinearLayout llListitem,
      @NonNull ProgressBar pbProgressAction, @NonNull RelativeLayout relLayout,
      @NonNull RelativeLayout relLayoutPhotoSimple, @NonNull TextView showMessage,
      @NonNull TextView showMessagePhoto, @NonNull TextView voiceHour) {
  ...
  public static MsgItemLeftBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MsgItemLeftBinding((LinearLayout) rootView, date, deletedComment, hour, hourPhoto,
          hourPhotoSimple, image, imageSimple, imgPlay, linLayout, linLayout2,
          linLayoutSimpleMessage, llListitem, pbProgressAction, relLayout, relLayoutPhotoSimple,
          showMessage, showMessagePhoto, voiceHour);
    }
