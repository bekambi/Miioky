...
public final class ActivityPubChallengePhotoBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityPubChallengePhotoBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityPubChallengePhotoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPubChallengePhotoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_pub_challenge_photo, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPubChallengePhotoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPubChallengePhotoBinding((RelativeLayout) rootView, boutonOk,
