...
public final class ActivityGroupSharePublicationInGroupBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityGroupSharePublicationInGroupBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityGroupSharePublicationInGroupBinding inflate(
  ...
  public static ActivityGroupSharePublicationInGroupBinding inflate(
    ...
    View root = inflater.inflate(R.layout.activity_group_share_publication_in_group, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityGroupSharePublicationInGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupSharePublicationInGroupBinding((RelativeLayout) rootView, arrowBack,
          editSearch, erase, loadingProgressBar, parent, recyclerView, relLayoutSearch,
