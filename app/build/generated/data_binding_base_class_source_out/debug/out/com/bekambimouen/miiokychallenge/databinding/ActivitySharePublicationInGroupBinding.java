...
public final class ActivitySharePublicationInGroupBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySharePublicationInGroupBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static ActivitySharePublicationInGroupBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySharePublicationInGroupBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_share_publication_in_group, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySharePublicationInGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySharePublicationInGroupBinding((LinearLayout) rootView, arrowBack,
